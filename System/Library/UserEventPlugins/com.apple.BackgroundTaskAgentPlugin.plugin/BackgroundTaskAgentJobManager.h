...
-(void)evalJobConditions:(id)arg1 withCurrentDeviceState:(SCD_Struct_Ba1*)arg2 andStoreJobStatusIn:(SCD_Struct_Ba3*)arg3 ;
...
-(BOOL)areNetworkingRequirementsMetForJob:(id)arg1 withCurrentDeviceState:(SCD_Struct_Ba1*)arg2 ;
-(void)printJobListwithPrefix:(const char*)arg1 withLogLevel:(int)arg2 withJobStatus:(BOOL)arg3 ;
-(void)hasJobStatusChanged:(id)arg1 withToken:(CFNumberRef)arg2 withCurrentDeviceState:(SCD_Struct_Ba1*)arg3 withPointerToExpiredJobs:(_CFDictionary*)arg4 ;
