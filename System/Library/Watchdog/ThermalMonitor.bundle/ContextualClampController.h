...
@interface ContextualClampController : NSObject <tGraphDataSource> {
	...
	int _temperatureThresholdsPreUVLO[3];
	int _chargeThresholdsPreUVLO[5];
	int _indexValuesPreUVLO[24];
	int _temperatureThresholdCountPreUVLO;
	int _chargeThresholdCountPreUVLO;
	int _responseTableCellCountPreUVLO;
	int _indexPreUVLO;
	int _temperatureRowPreUVLO;
