...
#import <GAXSpringboardServer/__GAXSBCommandTabControllerOverride_super.h>

@interface GAXSBCommandTabControllerOverride : __GAXSBCommandTabControllerOverride_super
