...
@property (assign,setter=_setSelectedVibrationIdentifierWasExplicitlySet:,nonatomic) BOOL _selectedVibrationIdentifierWasExplicitlySet;              //@synthesize selectedVibrationIdentifierWasExplicitlySet=_selectedVibrationIdentifierWasExplicitlySet - In the implementation block
