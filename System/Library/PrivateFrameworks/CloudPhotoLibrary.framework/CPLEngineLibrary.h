...
@class NSArray, NSObject, NSHashTable, NSError, CPLStatus, NSDate, CPLPlatformObject, NSURL, NSString, CPLEngineStore, CPLEngineScheduler, CPLEngineSyncManager, CPLEngineTransport, CPLEngineSystemMonitor, CPLConfiguration;
