...
-(id)_downloadTaskForLocalResource:(id)arg1 clientBundleID:(id)arg2 highPriority:(BOOL)arg3 background:(BOOL)arg4 backgroundTaskIdentifier:(unsigned long long)arg5 proposedTaskIdentifier:(id)arg6 didStartHandler:(/*^block*/id)arg7 progressHandler:(/*^block*/id)arg8 completionHandler:(/*^block*/id)arg9 ;
...
-(id)_realDownloadTaskForCloudResource:(id)arg1 clientBundleID:(id)arg2 launchHandler:(/*^block*/id)arg3 didStartHandler:(/*^block*/id)arg4 progressHandler:(/*^block*/id)arg5 completionHandler:(/*^block*/id)arg6 ;
