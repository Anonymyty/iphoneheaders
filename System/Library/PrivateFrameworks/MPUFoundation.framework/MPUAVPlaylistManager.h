...
@class NSMutableIndexSet, MPMutableBidirectionalDictionary, MPQueueFeeder, NSMutableArray, MPAVItem, _MPUAVItemSourceContext, NSMutableDictionary, NSString;
...
@property (nonatomic,copy) _MPUAVItemSourceContext * repeatPlaylistIdentifer;                       //@synthesize repeatPlaylistIdentifer=_repeatPlaylistIdentifer - In the implementation block
...
-(_MPUAVItemSourceContext *)repeatPlaylistIdentifer;
...
-(void)setRepeatPlaylistIdentifer:(_MPUAVItemSourceContext *)arg1 ;
