...
@class NSMapTable, NSMutableArray, CBService, CBCharacteristic, NSString, NSData, NSMutableData, NSObject;

@interface _HAPAccessoryServerBTLE100 : HAPAccessoryServerBTLE <CBPeripheralDelegate> {
