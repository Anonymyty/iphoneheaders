...
@class CKDQueryURLRequest, CKDQueryOperation, NSObject, NSMutableArray;

@interface CKDQueryRequestInfo : NSObject {

	CKDQueryURLRequest* _request;
	CKDQueryOperation* _operation;
...
@property (nonatomic,retain) CKDQueryURLRequest * request;                                      //@synthesize request=_request - In the implementation block
@property (assign,nonatomic,__weak) CKDQueryOperation * operation;                              //@synthesize operation=_operation - In the implementation block
...
-(CKDQueryOperation *)operation;
-(void)setOperation:(CKDQueryOperation *)arg1 ;
-(CKDQueryURLRequest *)request;
-(void)setRequest:(CKDQueryURLRequest *)arg1 ;
