...
@class CKDFetchRecordChangesURLRequest, CKDFetchRecordChangesOperation, NSObject, NSMutableArray;
...
@property (nonatomic,retain) CKDFetchRecordChangesURLRequest * request;                         //@synthesize request=_request - In the implementation block
@property (assign,nonatomic,__weak) CKDFetchRecordChangesOperation * operation;                 //@synthesize operation=_operation - In the implementation block
...
-(CKDFetchRecordChangesOperation *)operation;
-(void)setOperation:(CKDFetchRecordChangesOperation *)arg1 ;
-(CKDFetchRecordChangesURLRequest *)request;
-(void)setRequest:(CKDFetchRecordChangesURLRequest *)arg1 ;
