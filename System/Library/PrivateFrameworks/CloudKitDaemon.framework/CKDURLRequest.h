...
@protocol CKDAccountInfoProvider, CKDResponseBodyParser, CKDURLRequestMetricsDelegate, CKDURLRequestAuthRetryDelegate, OS_voucher;
@class NSOperationQueue, NSString, NSMutableDictionary, NSMutableArray, NSData, CKDProtobufStreamWriter, NSMutableData, NSDictionary, CKTimeLogger, CKDClientContext, CKDProtocolTranslator, NSArray, NSError, NSURLSessionConfiguration, NSURLSessionDataTask, NSURLRequest, NSHTTPURLResponse, NSFileHandle, CKBlockingAsyncQueue, NSDate, CKDOperationMetrics, NSObject, NSInputStream, NSURL;
...
@property (nonatomic,retain) CKBlockingAsyncQueue * trafficQueue;                                      //@synthesize trafficQueue=_trafficQueue - In the implementation block
...
-(NSString *)httpMethod;
-(CKBlockingAsyncQueue *)trafficQueue;
...
-(void)setTrafficQueue:(CKBlockingAsyncQueue *)arg1 ;
