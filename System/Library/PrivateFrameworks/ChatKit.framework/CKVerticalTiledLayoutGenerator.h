...
-(BOOL)_addRowWithContiguousTiles:(SCD_Struct_CK9*)arg1 count:(long long)arg2 ;
-(BOOL)_scanTilePair:(SCD_Struct_CK9*)arg1 ;
-(BOOL)_scanTileTriplet:(SCD_Struct_CK9*)arg1 ;
-(BOOL)_scanTileRequiringFullWidth:(SCD_Struct_CK9*)arg1 ;
-(BOOL)_scanTileRequiringNewRow:(SCD_Struct_CK9*)arg1 ;
-(BOOL)_hasLeftSuboptimalRow;
-(BOOL)_addRowWithTiles:(SCD_Struct_CK9*)arg1 imageFrames:(CGRect*)arg2 count:(long long)arg3 ;
-(BOOL)_scanTripletWithLargeLead:(SCD_Struct_CK9*)arg1 ;
-(BOOL)_scanTripletWithRearrangment:(SCD_Struct_CK9*)arg1 ;
...
-(BOOL)_scanSpecialSequenceRow:(SCD_Struct_CK9*)arg1 count:(long long*)arg2 ;
...
-(void)_enumerateRowFramesWithContiguousTiles:(SCD_Struct_CK9*)arg1 count:(long long)arg2 useMagneticGuidelines:(BOOL)arg3 block:(/*^block*/id)arg4 ;
