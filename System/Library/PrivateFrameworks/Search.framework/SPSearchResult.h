...
@interface SPSearchResult : PBCodable <PRSMapsResult, PRSiTunesResult, PRSSimpleResult, PRSGenericResult, PRSBaseResult, NSCopying> {
	...
	unsigned _geoUserSessionSequenceNumber;
...
@property (assign,nonatomic) unsigned geoUserSessionSequenceNumber; 
...
@property (assign,nonatomic) unsigned geoUserSessionSequenceNumber;                       //@synthesize geoUserSessionSequenceNumber=_geoUserSessionSequenceNumber - In the implementation block
...
-(void)setGeoUserSessionSequenceNumber:(unsigned)arg1 ;
...
-(unsigned)geoUserSessionSequenceNumber;
