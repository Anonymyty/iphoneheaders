...
@class UITextInteractionAssistant, NSString, UITextRange, NSDictionary, UITextPosition, UIView, NSIndexSet, UIColor, UIImage, WebArchive, DOMNodeList, DOMDocument, DOMNamedNodeMap, DOMElement;
