...
@class CKContainer, NSDate, NSOperationQueue, NSObject, NSMutableSet, ICThreadSafeMutableDictionary, NSTimer, ICSelectorDelayer, NSDictionary;
...
-(void)addCallbackBlocksToDeleteRecordsOperation:(id)arg1 recordIDsToDelete:(id)arg2 cloudObjects:(id)arg3 completionHandler:(/*^block*/id)arg4 ;
...
-(void)addCallbackBlocksToPushRecordsOperation:(id)arg1 recordsToSave:(id)arg2 cloudObjectsByRecordID:(id)arg3 completionHandler:(/*^block*/id)arg4 ;
