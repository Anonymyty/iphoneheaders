...
-(void)setFavoritesFolderIdentifier:(unsigned)arg1 postChangeNotification:(BOOL)arg2 ;
...
-(id)listWithID:(unsigned)arg1 skipOffset:(unsigned)arg2 includeHidden:(BOOL)arg3 filteredUsingString:(id)arg4 ;
