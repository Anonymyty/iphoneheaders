...
-(void)mayShareToWhitelistedSourceUnmanagedTargetAppWithServiceName:(id)arg1 auditToken:(SCD_Struct_MC0)arg2 originatingAccountIsManaged:(BOOL)arg3 completion:(/*^block*/id)arg4 ;
...
-(void)mayShareToAirDropForAuditToken:(SCD_Struct_MC0)arg1 originatingAccountIsManaged:(BOOL)arg2 completion:(/*^block*/id)arg3 ;
...
-(void)setKeyboardShortcutsAllowed:(BOOL)arg1 senderPID:(int)arg2 completion:(/*^block*/id)arg3 ;
...
-(void)setParametersForSettingsByType:(id)arg1 toSystem:(BOOL)arg2 user:(BOOL)arg3 passcode:(id)arg4 senderPID:(int)arg5 completion:(/*^block*/id)arg6 ;
