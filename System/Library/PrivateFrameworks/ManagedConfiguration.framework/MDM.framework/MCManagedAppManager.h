...
-(void)_SSVPromptForManagementWithStoreMetadata:(id)arg1 managementFlags:(int)arg2 changeManagementState:(int)arg3 attributes:(id)arg4 configuration:(id)arg5 mustRedownload:(BOOL)arg6 assertion:(id)arg7 completionBlock:(/*^block*/id)arg8 ;
-(void)_SSVRetrieveStoreLicenseMetadataWithStoreMetadata:(id)arg1 managementFlags:(int)arg2 changeManagementState:(int)arg3 attributes:(id)arg4 configuration:(id)arg5 mustRedownload:(BOOL)arg6 assertion:(id)arg7 completionBlock:(/*^block*/id)arg8 ;
...
-(void)_SSVInstallManagedAppWithStoreMetadata:(id)arg1 managementFlags:(int)arg2 attributes:(id)arg3 configuration:(id)arg4 assertion:(id)arg5 completionBlock:(/*^block*/id)arg6 ;
