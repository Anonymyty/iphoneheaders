...
@class NSUUID, NSMutableArray, NSMutableDictionary, NSObject, HMMessageDispatcher, HMDIDSMessageDispatcher, HMDAccessoryManager, NSMutableSet, NSArray, HMDPairedSync, HMDNameValidator, HMDPendingCloudSyncTransactions, HMDPowerManager, HMDCloudDataSyncManager, HMDMessageFilterChain, HMDIdentityRegistry, HMDCloudDataSyncStateFilter, HMDCloudReadOnlyModeFilter, HMDLocation, HMDApplicationRegistry, HMDClientConnection, HMDAssistantGather, HAPTimer, HMDTimeInformationMonitor, NSString;
...
@property (nonatomic,retain) NSArray * reachableWatchDeviceAddresses;                             //@synthesize reachableWatchDeviceAddresses=_reachableWatchDeviceAddresses - In the implementation block
...
@property (nonatomic,retain) HMDCloudReadOnlyModeFilter * cloudReadonlyFilter;                    //@synthesize cloudReadonlyFilter=_cloudReadonlyFilter - In the implementation block
...
@property (nonatomic,retain) HAPTimer * remoteAccessHealthMonitorTimer;                           //@synthesize remoteAccessHealthMonitorTimer=_remoteAccessHealthMonitorTimer - In the implementation block
...
@property (nonatomic,retain) HAPTimer * cloudkitAccountChangedDebounceTimer;                      //@synthesize cloudkitAccountChangedDebounceTimer=_cloudkitAccountChangedDebounceTimer - In the implementation block
...
-(void)sendUserRemoved:(id)arg1 fromHome:(id)arg2 pairingUsername:(id)arg3 completionHandler:(/*^block*/id)arg4 ;
...
-(void)setHomeConfigurationKey:(CFStringRef)arg1 value:(void*)arg2 ;
-(NSArray *)reachableWatchDeviceAddresses;
-(void)setReachableWatchDeviceAddresses:(NSArray *)arg1 ;
...
-(void)setCloudkitAccountChangedDebounceTimer:(HAPTimer *)arg1 ;
...
-(void)_sendUserRemoved:(id)arg1 fromHome:(id)arg2 pairingUsername:(id)arg3 completionHandler:(/*^block*/id)arg4 ;
...
-(void)_mergeHomeDataWithRemoteHomes:(id)arg1 remotePrimaryHome:(id)arg2 remoteAccessories:(id)arg3 needConflictResolution:(BOOL)arg4 idsDataSync:(BOOL)arg5 idsSyncUser:(id)arg6 dataVersion:(long long)arg7 newResidentDevice:(BOOL*)arg8 ;
...
-(void)_suspendXPCConnectionAndMergeRemoteHomes:(id)arg1 remotePrimaryHome:(id)arg2 remoteAccessories:(id)arg3 needConflictResolution:(BOOL)arg4 idsDataSync:(BOOL)arg5 idsSyncUser:(id)arg6 dataVersion:(long long)arg7 completionHandler:(/*^block*/id)arg8 ;
...
-(HMDCloudReadOnlyModeFilter *)cloudReadonlyFilter;
...
-(void)setCloudReadonlyFilter:(HMDCloudReadOnlyModeFilter *)arg1 ;
...
-(void)setRemoteAccessHealthMonitorTimer:(HAPTimer *)arg1 ;
