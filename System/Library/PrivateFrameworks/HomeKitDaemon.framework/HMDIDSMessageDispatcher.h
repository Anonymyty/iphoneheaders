...
@class HMMessageDispatcher, NSMutableDictionary, HMDMessageFilterChain, HMDAdminEnforcementMessageFilter, HMDIdentityRegistry, HMDNotificationRelay, HMDIDSMessageTransport, HMDHomeManager, HMDSecureSessionNotifications, NSArray, NSSet;
