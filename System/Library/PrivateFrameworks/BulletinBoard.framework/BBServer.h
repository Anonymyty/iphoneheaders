...
@class NSMutableDictionary, BBDataProviderManager, NSMutableSet, NSMutableArray, NSArray, NSDate, NSObject, NSString, NSDateComponents, BBSyncService, NSXPCListener, BBApplicationLauncher, BBDismissalSyncCache, ABFavoritesListManager;
