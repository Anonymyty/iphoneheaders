...
@class AFUIDelayedActionCommandCache, SiriUIConfiguration, AFUISiriSession, AFUISiriRemoteViewController, NSObject, SiriUIAudioRoutePickerController, UIStatusBar, AFUIRequestOptions, NSNumber, NSString;
...
-(void)siriRemoteViewController:(id)arg1 launchApplicationWithBundleIdentifier:(id)arg2 withURL:(id)arg3 launchOverSiri:(BOOL)arg4 replyHandler:(/*^block*/id)arg5 ;
