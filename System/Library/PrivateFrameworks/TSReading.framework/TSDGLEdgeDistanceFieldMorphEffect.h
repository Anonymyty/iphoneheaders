...
-(id)initWithOutgoingTextureName:(unsigned)arg1 outgoingTextureSize:(CGSize)arg2 outgoingTextBounds:(CGRect)arg3 outgoingColor:(SCD_Struct_TS80)arg4 incomingTextureName:(unsigned)arg5 incomingTextureSize:(CGSize)arg6 incomingTextBounds:(CGRect)arg7 incomingColor:(SCD_Struct_TS80)arg8 ;
