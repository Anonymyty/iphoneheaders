...
@interface TSTTableRepProcessChangesActions : NSObject {
	...
	SCD_Struct_TS137 dirtyCellRange;
	SCD_Struct_TS137 dirtyStrokeRange;

}

@property (assign,nonatomic) SCD_Struct_TS138 dirtyCellRange; 
@property (assign,nonatomic) SCD_Struct_TS138 dirtyStrokeRange; 
...
-(void)setDirtyCellRange:(SCD_Struct_TS138)arg1 ;
-(void)setDirtyStrokeRange:(SCD_Struct_TS138)arg1 ;
-(SCD_Struct_TS138)dirtyCellRange;
-(SCD_Struct_TS138)dirtyStrokeRange;
