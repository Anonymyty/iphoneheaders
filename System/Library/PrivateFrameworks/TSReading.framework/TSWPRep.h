...
@class CALayer, CAShapeLayer, TSKHighlightArrayController, TSKPulseAnimationController, TSWPStorageSpellChecker, TSWPSelection, TSWPSearchReference, NSArray, TSWPLayout, TSWPStorage, TSWPEditingController, NSString;

@interface TSWPRep : TSDContainerRep <UIAccessibilityReadingContent, TSKHighlightArrayControllerProtocol, TSKPulseAnimationControllerProtocol, TSWPHyperlinkHostRepProtocol, TSDDecorator> {
...
-(id)_sxaxColumnForLineIndex:(long long)arg1 ;
-(NSRange)_sxaxStorageRelativeRangeFromRepRelativeRange:(NSRange)arg1 ;
-(id)_sxaxColumnForStorageRelativeCharIndex:(unsigned long long)arg1 ;
-(NSRange)_sxaxRepRelativeRangeFromStorageRelativeRange:(NSRange)arg1 ;
-(NSRange)_sxaxStorageRelativeRangeOfLineFragmentAtStorageRelativeCharIndex:(unsigned long long)arg1 ;
-(NSRange)_sxaxStorageRangeFromRepRange:(NSRange)arg1 ;
...
-(SCD_Struct_TS113)lineMetricsAtPoint:(CGPoint)arg1 ;
...
-(SCD_Struct_TS113)lineMetricsAtCharIndex:(unsigned long long)arg1 ;
...
-(SCD_Struct_TS132)wordMetricsAtCharIndex:(unsigned long long)arg1 ;
