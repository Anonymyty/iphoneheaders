...
@interface TSTLayoutHint : NSObject <TSDHint, NSCoding> {
	...
	BOOL mIsValid;
	BOOL mHorizontal;
	SCD_Struct_TS137 mCellRange;
	SCD_Struct_TS136 mCacheHintID;
...
@property (assign,nonatomic) SCD_Struct_TS138 cellRange; 
@property (assign,nonatomic) SCD_Struct_TS136 cacheHintID; 
...
-(void)setCellRange:(SCD_Struct_TS138)arg1 ;
-(void)setCacheHintID:(SCD_Struct_TS136)arg1 ;
-(void)setPartitionPosition:(unsigned)arg1 ;
-(SCD_Struct_TS136)cacheHintID;
-(unsigned)partitionPosition;
-(void)setPartitioningPass:(NSNumber *)arg1 ;
-(NSNumber *)partitioningPass;
-(id)initWithRange:(SCD_Struct_TS138)arg1 hintId:(SCD_Struct_TS136)arg2 partitionPosition:(unsigned)arg3 maximumSize:(CGSize)arg4 effectiveSize:(CGSize)arg5 layout:(id)arg6 validity:(BOOL)arg7 horizontal:(BOOL)arg8 ;
