...
@interface TSTEditingState : TSPObject <TSWPStorageObserver> {
	...
	SCD_Struct_TS136 mEditingCellID;
	int mEditingMode;
	...
	SCD_Struct_TS136 _lastEditingCellID;
...
@property (assign,nonatomic) SCD_Struct_TS136 editingCellID; 
@property (nonatomic,readonly) SCD_Struct_TS138 editingCellRange; 
@property (assign,nonatomic) TSTTableInfo * tableInfo; 
@property (assign,nonatomic) SCD_Struct_TS136 lastEditingCellID;                                                             //@synthesize lastEditingCellID=_lastEditingCellID - In the implementation block
...
-(int)editingMode;
-(SCD_Struct_TS136)editingCellID;
...
-(void)setEditingCellID:(SCD_Struct_TS136)arg1 ;
...
-(SCD_Struct_TS138)editingCellRange;
-(id)storageForCellID:(SCD_Struct_TS136)arg1 ;
-(id)prepareEditingStorageToEditCell:(SCD_Struct_TS136)arg1 ;
...
-(SCD_Struct_TS136)lastEditingCellID;
-(void)setLastEditingCellID:(SCD_Struct_TS136)arg1 ;
