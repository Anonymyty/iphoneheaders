...
@interface TSTLayout : TSWPTextHostLayout <TSKSearchTarget, TSWPColumnMetrics, TSWPLayoutParent, TSWPStorageObserver> {
	...
	SCD_Struct_TS137 mEditingSpillingTextRange;
...
@property (nonatomic,readonly) SCD_Struct_TS138 editingSpillingTextRange; 
...
-(SCD_Struct_TS138)editingSpillingTextRange;
...
-(void)setupContainedTextEditingLayout:(SCD_Struct_TS136)arg1 ;
-(void)p_updateCachedStyleInformationFromCellID:(SCD_Struct_TS136)arg1 ;
-(unsigned)p_naturalAlignmentForCellID:(SCD_Struct_TS136)arg1 ;
-(unsigned)p_defaultAlignmentForTableWritingDirection;
-(CGRect)computedEditingCellContentFrame;
-(BOOL)p_layoutWhollyContainsGridRange:(SCD_Struct_TS172)arg1 ;
-(CGSize)p_rangeUpAndLeftOfIntersectionRangeOfGridRange:(SCD_Struct_TS172)arg1 ;
-(CGRect)p_computeSpillingTextFrameForLayout:(id)arg1 textSize:(CGSize)arg2 editingSpillRange:(SCD_Struct_TS138*)arg3 ;
