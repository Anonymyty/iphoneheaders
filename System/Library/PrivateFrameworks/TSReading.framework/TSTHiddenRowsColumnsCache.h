...
-(unsigned short)numberRowsHiddenInCellRange:(SCD_Struct_TS138)arg1 ;
-(unsigned short)numberRowsUserHiddenInCellRange:(SCD_Struct_TS138)arg1 ;
-(unsigned short)numberColumnsHiddenInCellRange:(SCD_Struct_TS138)arg1 ;
-(BOOL)anyRowsHiddenInCellRange:(SCD_Struct_TS138)arg1 ;
-(BOOL)anyRowsUserHiddenInCellRange:(SCD_Struct_TS138)arg1 ;
-(BOOL)anyColumnsHiddenInCellRange:(SCD_Struct_TS138)arg1 ;
...
-(SCD_Struct_TS136)visibleCellOffsetBy:(SCD_Struct_TS83)arg1 fromCellID:(SCD_Struct_TS136)arg2 ;
