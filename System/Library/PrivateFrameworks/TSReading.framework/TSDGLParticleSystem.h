...
-(SCD_Struct_TS75)vertexPositionAtVertexIndex:(unsigned long long)arg1 particleIndexPoint:(CGPoint)arg2 ;
-(SCD_Struct_TS75)centerAtIndexPoint:(CGPoint)arg1 ;
-(CGPoint)startingPointAtIndexPoint:(CGPoint)arg1 ;
-(SCD_Struct_TS79)speedAtIndexPoint:(CGPoint)arg1 ;
-(SCD_Struct_TS79)rotationAtIndexPoint:(CGPoint)arg1 ;
-(double)scaleAtIndexPoint:(CGPoint)arg1 ;
-(SCD_Struct_TS75)lifeSpanAtIndexPoint:(CGPoint)arg1 ;
-(SCD_Struct_TS80)colorAtIndexPoint:(CGPoint)arg1 ;
