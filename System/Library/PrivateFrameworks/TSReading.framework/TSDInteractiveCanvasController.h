...
@property (nonatomic,readonly) SCD_Struct_TS68 screenTopContentPlacement; 
@property (nonatomic,readonly) SCD_Struct_TS68 screenBottomContentPlacement; 
...
-(id)clampContentLocation:(id)arg1 forPlacement:(SCD_Struct_TS68)arg2 ;
-(id)clampedCenterContentLocationForPoint:(CGPoint)arg1 withPlacement:(SCD_Struct_TS68)arg2 viewScale:(double)arg3 ;
-(SCD_Struct_TS68)screenTopContentPlacement;
-(SCD_Struct_TS68)screenBottomContentPlacement;
-(CGPoint)clampedCenterPointForPoint:(CGPoint)arg1 withPlacement:(SCD_Struct_TS68)arg2 viewScale:(double)arg3 ;
-(SCD_Struct_TS68)contentPlacementForPoint:(CGPoint)arg1 inView:(id)arg2 ;
