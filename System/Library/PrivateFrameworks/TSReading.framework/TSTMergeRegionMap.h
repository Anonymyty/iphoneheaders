...
@interface TSTMergeRegionMap : TSPObject {
	...
	SCD_Struct_TS137 mUnionedMergeRange;

}
+(id)mergeRegionMapFromMap:(id)arg1 intersectingRange:(SCD_Struct_TS138)arg2 ;
-(SCD_Struct_TS138)mergedRangeForCellID:(SCD_Struct_TS136)arg1 ;
-(id)iterator;
-(BOOL)partiallyIntersectsCellRange:(SCD_Struct_TS138)arg1 ;
-(id)initRegionMapFromMap:(id)arg1 rowRemapping:(id)arg2 ;
-(SCD_Struct_TS138)unionedMergeRange;
-(id)mergedGridIndicesForDimension:(int)arg1 ;
-(id)initRegionMapFromMap:(id)arg1 intersectingRange:(SCD_Struct_TS138)arg2 ;
-(BOOL)partiallyIntersectsCellRegion:(id)arg1 ;
-(BOOL)hasRangeSpanningRows;
-(BOOL)find:(SCD_Struct_TS138)arg1 ;
-(unsigned long long)count;
-(id)description;
-(id)initWithContext:(id)arg1 ;
-(BOOL)remove:(SCD_Struct_TS138)arg1 ;
-(BOOL)insert:(SCD_Struct_TS138)arg1 ;
@end
