...
-(void)p_selection:(id)arg1 toGlyphRange:(SCD_Struct_TS108*)arg2 ;
-(unsigned long long)p_LeftCharForInsertion:(const SCD_Struct_TS108*)arg1 ;
-(const TSWPLineFragment*)p_lineFragmentWithCaretInfo:(SCD_Struct_TS109*)arg1 forSelection:(id)arg2 ;
...
-(void)p_beginHorizontalRangedMagnificationForRep:(id)arg1 unscaledCanvasPoint:(CGPoint)arg2 ;
-(id)p_updateEditingRepIfApplicableWithGesture:(id)arg1 unscaledCanvasPoint:(CGPoint)arg2 ;
-(void)p_moveHorizontalRangedLoupeForRep:(id)arg1 unscaledCanvasPoint:(CGPoint)arg2 ;
