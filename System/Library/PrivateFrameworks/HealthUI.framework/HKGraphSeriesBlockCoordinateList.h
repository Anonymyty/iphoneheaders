...
@property (nonatomic,readonly) SCD_Struct_HK6 blockPathStart; 
@property (nonatomic,readonly) SCD_Struct_HK6 blockPathEnd; 
+(id)coordinateListByCombiningSubCoordinates:(id)arg1 chartableDateRange:(id)arg2 ;
+(id)coordinateListWithCoordinates:(id)arg1 blockPath:(SCD_Struct_HK6)arg2 ;
-(NSArray *)coordinates;
