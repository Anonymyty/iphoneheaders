...
@interface WDParagraphProperties : NSObject <NSCopying> {
	...
	SCD_Struct_WD106* mOriginalProperties;
	SCD_Struct_WD106* mTrackedProperties;

}
-(id)description;
-(BOOL)isAnythingOverriddenIn:(SCD_Struct_WD106*)arg1 ;
-(void)dealloc;
...
-(void)setDropCap:(SCD_Struct_WD105)arg1 ;
...
-(void)addTabStopAdded:(SCD_Struct_WD107*)arg1 ;
...
-(SCD_Struct_WD105)dropCap;
-(unsigned long long)tabStopAddedCount;
-(SCD_Struct_WD107*)tabStopAddedAt:(unsigned long long)arg1 ;
