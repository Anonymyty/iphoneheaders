...
+(BOOL)readOptionalStringAttribute:(id)arg1 fromNode:(xmlNode*)arg2 attributeMap:(attributeMapEntry*)arg3 attributeCount:(int)arg4 toPDDomValue:(unsigned long long*)arg5 ;
