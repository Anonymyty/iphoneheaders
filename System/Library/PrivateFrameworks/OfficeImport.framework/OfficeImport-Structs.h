...
@class NSString, NSUUID, TSUCustomFormat, <TSUMultipleChoiceListChoiceProviding>, OITSUColor, EDString, WDBorder, NSMutableArray, NSDate, WDShading, WDStyle;
...
typedef struct {
	...
	SCD_Struct_TS50 mDateFormatStruct;
	SCD_Struct_TS51 mDurationFormatStruct;
	SCD_Struct_TS52 mCustomFormatStruct;
	SCD_Struct_TS53 mControlFormatStruct;
	SCD_Struct_TS54) mMultipleChoiceListFormatStruct;
} SCD_Struct_TS55;
...
typedef struct {
	...
	SCD_Struct_TS51 field10;
	SCD_Struct_TS53) field11;
} SCD_Struct_TS56;
