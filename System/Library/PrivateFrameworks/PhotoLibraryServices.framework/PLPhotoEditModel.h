...
@interface PLPhotoEditModel : NSObject <NSCopying> {
	...
	SCD_Struct_PL25 _trimStartTimeOffset;
	SCD_Struct_PL25 _trimEndTimeOffset;
...
@property (nonatomic,readonly) SCD_Struct_PL25 trimStartTimeOffset;                                //@synthesize trimStartTimeOffset=_trimStartTimeOffset - In the implementation block
@property (nonatomic,readonly) SCD_Struct_PL25 trimEndTimeOffset;                                  //@synthesize trimEndTimeOffset=_trimEndTimeOffset - In the implementation block
...
+(double)_referenceValueOfType:(long long)arg1 fromLevels:(SCD_Struct_PL26)arg2 ;
...
-(SCD_Struct_PL25)trimStartTimeOffset;
-(SCD_Struct_PL25)trimEndTimeOffset;
