...
@class NSString, PLImageFormat, NSMutableArray, NSMutableIndexSet, NSObject, NSDictionary;
...
-(void)finishUnicornEntryAtIndex:(unsigned long long)arg1 withImageData:(id)arg2 imageSize:(CGSize)arg3 assetUUID:(id)arg4 ;
@end
