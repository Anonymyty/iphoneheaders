...
@class BRCItemID, NSString, BRCStatInfo, NSNumber, BRCAccountSession, BRCServerZone, BRCLocalContainer, BRCLocalStatInfo, CKRecordID, CKRecord, BRCAliasItem, BRCDirectoryItem, BRCDocumentItem, NSMutableSet, NSError;
