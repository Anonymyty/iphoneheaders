...
@class NSObject, NSXPCListener, BRCAccountSession, BRCCloudFileProvider, BRCVersionsFileProvider, BRCAccountHandler, UMUserSyncTask, NSString, NSError, NSDate, NSXPCListenerEndpoint;
