...
+(PQLResultSet*)packageItemsForItem:(id)arg1 order:(unsigned long long)arg2 ;
...
+(PQLResultSet*)packageItemsForDocumentID:(unsigned)arg1 order:(unsigned long long)arg2 container:(id)arg3 ;
