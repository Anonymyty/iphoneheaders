...
@interface FigCoreMotionDelegate : NSObject {
	...
	SCD_Struct_Fi54 fusedRingAccel[256];
	SCD_Struct_Fi55 fusedRingQuaternion[256];
	SCD_Struct_Fi54 fusedRingPosition[256];
	...
	SCD_Struct_Fi55 previousQuaternion;
	SCD_Struct_Fi55 currentQuaternion;
	BOOL computingPosition;
	SCD_Struct_Fi57 position;
	SCD_Struct_Fi57 velocity;
...
-(void)didUpdatePositionWithAcceleration:(SCD_Struct_Fi54*)arg1 forTimeStamp:(double)arg2 ;
-(void)didUpdateVelocityWithAcceleration:(SCD_Struct_Fi54*)arg1 forTimeStamp:(double)arg2 ;
-(void)didUpdatePositionWithTimeStamp:(double)arg1 ;
-(void)getCurrentDeltaQuaternion:(SCD_Struct_Fi55*)arg1 ;
-(void)updateDeviceCallback:(BOOL)arg1 fusedMotionUpdateInterval:(float)arg2 ;
-(void)updateGyroInterval:(float)arg1 ;
-(void)didUpdateAcceleration:(SCD_Struct_Fi54)arg1 time:(double)arg2 ;
-(void)didUpdateGravity:(SCD_Struct_Fi54)arg1 time:(double)arg2 ;
...
-(void)didUpdateFusedMotionWithDeviceMotion:(SCD_Struct_Fi58)arg1 time:(double)arg2 ifsync:(BOOL)arg3 ;
...
-(void)getCurrentQuaternion:(SCD_Struct_Fi55*)arg1 ;
