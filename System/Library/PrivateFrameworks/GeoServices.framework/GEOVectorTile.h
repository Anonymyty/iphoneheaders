...
@interface GEOVectorTile : NSObject {
	...
	SCD_Struct_GE98* _transitLinkSections;
...
@property (nonatomic,readonly) const SCD_Struct_GE98* transitLinkSections;                         //@synthesize transitLinkSections=_transitLinkSections - In the implementation block
...
-(const SCD_Struct_GE98*)transitLinkSections;
