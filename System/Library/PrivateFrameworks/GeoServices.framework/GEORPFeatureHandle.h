...
@interface GEORPFeatureHandle : PBCodable <NSCopying> {
	...
	SCD_Struct_GE229* _styleAttributes;
...
@property (nonatomic,readonly) SCD_Struct_GE229* styleAttributes; 
-(void)dealloc;
...
-(BOOL)hasType;
-(SCD_Struct_GE229*)styleAttributes;
...
-(void)addStyleAttribute:(SCD_Struct_GE229)arg1 ;
...
-(SCD_Struct_GE229)styleAttributeAtIndex:(unsigned long long)arg1 ;
-(void)setHasFeatureIndex:(BOOL)arg1 ;
-(BOOL)hasFeatureTileX;
-(void)setStyleAttributes:(SCD_Struct_GE229*)arg1 count:(unsigned long long)arg2 ;
