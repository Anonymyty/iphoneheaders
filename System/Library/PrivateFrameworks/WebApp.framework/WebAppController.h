...
@class UIWindow, UIWebView, UIView, UIWebClip, NSTimer, WBUSheetController, NSMutableArray, WebUIAuthenticationManager, NSArray, WebUIDownloadManager, NSDictionary, NSMutableSet, NSString;
