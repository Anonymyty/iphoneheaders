...
@protocol OS_dispatch_source, IKApplication, IKAppContextDelegate;
@class NSObject, JSContext, NSMutableArray, IKJSFoundation, IKJSInspectorController, NSString, NSError;
