...
@property (assign,nonatomic) id<WebUIDelegate> UIDelegate; 
@property (assign,nonatomic) id<WebResourceLoadDelegate> resourceLoadDelegate; 
@property (assign,nonatomic) id<WebDownloadDelegate> downloadDelegate; 
@property (assign,nonatomic) id<WebFrameLoadDelegate> frameLoadDelegate; 
@property (assign,nonatomic) id<WebPolicyDelegate> policyDelegate; 
...
-(void)_enterVideoFullscreenForVideoElement:(HTMLVideoElement*)arg1 mode:(unsigned)arg2 ;
...
-(CGSize)_contentsSizeRespectingOverflow;
...
-(void)_setHostApplicationProcessIdentifier:(int)arg1 auditToken:(SCD_Struct_We58)arg2 ;
...
-(void)setDownloadDelegate:(id<WebDownloadDelegate>)arg1 ;
...
-(void)setPolicyDelegate:(id<WebPolicyDelegate>)arg1 ;
...
-(BOOL)isLoading;
-(void)setFrameLoadDelegate:(id<WebFrameLoadDelegate>)arg1 ;
-(void)setUIDelegate:(id<WebUIDelegate>)arg1 ;
-(void)setResourceLoadDelegate:(id<WebResourceLoadDelegate>)arg1 ;
