...
-(void)sdk_createPlaylistWithPersistentID:(unsigned long long)arg1 properties:(id)arg2 tracklist:(id)arg3 completionHandler:(/*^block*/id)arg4 ;
...
-(void)importArtistHeroImageForPersistentID:(unsigned long long)arg1 completionHandler:(/*^block*/id)arg2 ;
-(void)importAlbumArtistHeroImageForPersistentID:(unsigned long long)arg1 completionHandler:(/*^block*/id)arg2 ;
