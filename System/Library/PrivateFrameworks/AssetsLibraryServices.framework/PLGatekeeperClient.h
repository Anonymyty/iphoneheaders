...
-(void)downloadCloudPhotoLibraryAsset:(id)arg1 resourceType:(unsigned long long)arg2 highPriority:(BOOL)arg3 trackCPLDownload:(BOOL)arg4 proposedTaskIdentifier:(id)arg5 completion:(/*^block*/id)arg6 ;
