...
#import <libobjc.A.dylib/PLCameraEffectsRendererDelegate.h>
...
@interface CMKCaptureController : NSObject <AVCaptureMetadataOutputObjectsDelegate, PLCameraEffectsRendererDelegate, BKSAccelerometerDelegate, AVCaptureFileOutputRecordingDelegate, AVCaptureVideoDataOutputSampleBufferDelegate> {
	...
	struct {
		...
		unsigned hasBackFlash : 1;
		unsigned hasFrontFlash : 1;
		...
		unsigned delegateRemoteShutterSetFlashMode : 1;
		unsigned delegateRemoteShutterToggleCameraDevice : 1;
...
@property (retain) CMKEffectsRenderer * effectsRenderer;                                                                                                                               //@synthesize effectsRenderer=_effectsRenderer - In the implementation block
...
@property (nonatomic,readonly) CMKAvalancheCaptureService * _avalancheCaptureService;                                                                                                  //@synthesize _avalancheCaptureService=__avalancheCaptureService - In the implementation block
@property (nonatomic,readonly) CMKDebugCaptureService * _debugCaptureService;                                                                                                          //@synthesize _debugCaptureService=__debugCaptureService - In the implementation block
...
-(void)_deviceConfigurationForPanoramaOptions:(CFDictionaryRef)arg1 captureDevice:(id)arg2 deviceFormat:(id*)arg3 minFrameDuration:(SCD_Struct_CM12*)arg4 maxFrameDuration:(SCD_Struct_CM12*)arg5 ;
...
-(CMKAvalancheCaptureService *)_avalancheCaptureService;
...
-(CMKDebugCaptureService *)_debugCaptureService;
...
-(CMKEffectsRenderer *)effectsRenderer;
