...
#import <libobjc.A.dylib/CMKModeDialDataSource.h>
#import <libobjc.A.dylib/CMKTopBarDelegate.h>
#import <libobjc.A.dylib/CMKBottomBarDelegate.h>
#import <libobjc.A.dylib/CMKZoomSliderDelegate.h>
#import <libobjc.A.dylib/CMKTimerButtonDelegate.h>
#import <libobjc.A.dylib/CMKStillImageCaptureRequestDelegate.h>
#import <libobjc.A.dylib/PLCameraControllerDelegate.h>
#import <libobjc.A.dylib/PLCameraPanoramaViewDelegate.h>
#import <UIKit/UIGestureRecognizerDelegate.h>
#import <UIKit/UIAccelerometerDelegate.h>

@protocol OS_dispatch_source;
@class CMKCaptureController, CALayer, CMKPanoramaView, UIView, UITapGestureRecognizer, UILongPressGestureRecognizer, UIPanGestureRecognizer, PLCameraOverlayTextLabelView, NSTimer, CMKGridView, PLCameraIrisAnimationView, UIImageView, NSMutableArray, UIAlertView, CMKLowDiskSpaceAlertView, CMKCameraSpec, CMKPhysicalCaptureRecognizer, CMKPreviewView, PLPreviewOverlayView, CMKDisabledModeOverlayView, CMKTopBar, CMKFlashButton, CMKFlashBadge, CMKHDRButton, CMKHDRBadge, CMKElapsedTimeView, CMKFlipButton, CMKBottomBar, CMKModeDial, CMKImageWell, CMKShutterButton, CMKFilterButton, CMKZoomSlider, CMKAvalancheIndicatorView, CMKSlalomIndicatorView, CMKHardwareLockIndicatorView, CMKTimerButton, CMKTimerIndicatorView, CMKShutterIndicatorView, CMKExposureBiasTextView, CMKBlurredSnapshotView, UISwipeGestureRecognizer, NSObject, CMKAnimationDelegate, CMKTorchPatternController, NSDate, CMKMotionController, NSMutableSet, NSString;
...
@property (nonatomic,readonly) CMKCameraSpec * spec;                                                                                                                                         //@synthesize spec=_spec - In the implementation block
...
@property (nonatomic,retain) CMKPhysicalCaptureRecognizer * physicalCaptureRecognizer;                                                                                                       //@synthesize physicalCaptureRecognizer=_physicalCaptureRecognizer - In the implementation block
...
@property (nonatomic,readonly) CMKPreviewView * previewView;                                                                                                                                 //@synthesize previewView=_previewView - In the implementation block
...
@property (nonatomic,readonly) CMKDisabledModeOverlayView * _disabledModeOverlayView;                                                                                                        //@synthesize _disabledModeOverlayView=__disabledModeOverlayView - In the implementation block
...
@property (nonatomic,readonly) CMKTopBar * _topBar;                                                                                                                                          //@synthesize _topBar=__topBar - In the implementation block
@property (nonatomic,readonly) CMKFlashButton * _flashButton;                                                                                                                                //@synthesize _flashButton=__flashButton - In the implementation block
@property (nonatomic,readonly) CMKFlashBadge * _flashBadge;                                                                                                                                  //@synthesize _flashBadge=__flashBadge - In the implementation block
@property (nonatomic,readonly) CMKHDRButton * _HDRButton;                                                                                                                                    //@synthesize _HDRButton=__HDRButton - In the implementation block
@property (nonatomic,readonly) CMKHDRBadge * _HDRBadge;                                                                                                                                      //@synthesize _HDRBadge=__HDRBadge - In the implementation block
@property (nonatomic,readonly) CMKElapsedTimeView * _elapsedTimeView;                                                                                                                        //@synthesize _elapsedTimeView=__elapsedTimeView - In the implementation block
@property (nonatomic,readonly) CMKFlipButton * _flipButton;                                                                                                                                  //@synthesize _flipButton=__flipButton - In the implementation block
@property (nonatomic,readonly) CMKBottomBar * _bottomBar;                                                                                                                                    //@synthesize _bottomBar=__bottomBar - In the implementation block
@property (nonatomic,readonly) CMKModeDial * _modeDial;                                                                                                                                      //@synthesize _modeDial=__modeDial - In the implementation block
@property (nonatomic,readonly) CMKImageWell * _imageWell;                                                                                                                                    //@synthesize _imageWell=__imageWell - In the implementation block
@property (nonatomic,readonly) CMKShutterButton * _stillDuringVideoButton;                                                                                                                   //@synthesize _stillDuringVideoButton=__stillDuringVideoButton - In the implementation block
@property (nonatomic,readonly) CMKShutterButton * _shutterButton;                                                                                                                            //@synthesize _shutterButton=__shutterButton - In the implementation block
@property (nonatomic,readonly) CMKFilterButton * _filterButton;                                                                                                                              //@synthesize _filterButton=__filterButton - In the implementation block
@property (nonatomic,readonly) CMKZoomSlider * _zoomSlider;                                                                                                                                  //@synthesize _zoomSlider=__zoomSlider - In the implementation block
@property (nonatomic,readonly) CMKAvalancheIndicatorView * _avalancheIndicator;                                                                                                              //@synthesize _avalancheIndicator=__avalancheIndicator - In the implementation block
@property (nonatomic,readonly) CMKSlalomIndicatorView * _slalomIndicator;                                                                                                                    //@synthesize _slalomIndicator=__slalomIndicator - In the implementation block
@property (nonatomic,readonly) CMKHardwareLockIndicatorView * _hardwareLockIndicator;                                                                                                        //@synthesize _hardwareLockIndicator=__hardwareLockIndicator - In the implementation block
@property (nonatomic,readonly) CMKTimerButton * _timerButton;                                                                                                                                //@synthesize _timerButton=__timerButton - In the implementation block
@property (nonatomic,readonly) CMKTimerIndicatorView * _timerIndicator;                                                                                                                      //@synthesize _timerIndicator=__timerIndicator - In the implementation block
@property (nonatomic,readonly) CMKShutterIndicatorView * _shutterIndicator;                                                                                                                  //@synthesize _shutterIndicator=__shutterIndicator - In the implementation block
@property (nonatomic,readonly) CMKExposureBiasTextView * _exposureBiasTextView;                                                                                                              //@synthesize _exposureBiasTextView=__exposureBiasTextView - In the implementation block
...
@property (nonatomic,readonly) CMKBlurredSnapshotView * _suspensionSnapshotView;                                                                                                             //@synthesize _suspensionSnapshotView=__suspensionSnapshotView - In the implementation block
@property (nonatomic,readonly) CMKBlurredSnapshotView * _captureSnapshotView;                                                                                                                //@synthesize _captureSnapshotView=__captureSnapshotView - In the implementation block
...
@property (nonatomic,readonly) CMKBlurredSnapshotView * _currentDeviceFrontSnapshotView;                                                                                                     //@synthesize _currentDeviceFrontSnapshotView=__currentDeviceFrontSnapshotView - In the implementation block
@property (nonatomic,readonly) CMKBlurredSnapshotView * _currentDeviceBackSnapshotView;                                                                                                      //@synthesize _currentDeviceBackSnapshotView=__currentDeviceBackSnapshotView - In the implementation block
@property (nonatomic,readonly) CMKBlurredSnapshotView * _targetDeviceSnapshotView;                                                                                                           //@synthesize _targetDeviceSnapshotView=__targetDeviceSnapshotView - In the implementation block
...
@property (nonatomic,readonly) CMKBlurredSnapshotView * _modeSwitchingSnapshotView;                                                                                                          //@synthesize _modeSwitchingSnapshotView=__modeSwitchingSnapshotView - In the implementation block
...
@property (nonatomic,readonly) CMKAnimationDelegate * _delayedCaptureAnimationDelegate;                                                                                                      //@synthesize _delayedCaptureAnimationDelegate=__delayedCaptureAnimationDelegate - In the implementation block
...
@property (nonatomic,readonly) CMKTorchPatternController * _torchPatternController;                                                                                                          //@synthesize _torchPatternController=__torchPatternController - In the implementation block
...
@property (nonatomic,readonly) BOOL _supportsLockButtonForCapture;                                                                                                                           //@synthesize _supportsLockButtonForCapture=__supportsLockButtonForCapture - In the implementation block
@property (assign,setter=_setIgnoringDominantPhysicalButtonNotifications:,nonatomic) BOOL _ignoringDominantPhysicalButtonNotifications;                                                      //@synthesize _ignoringDominantPhysicalButtonNotifications=__ignoringDominantPhysicalButtonNotifications - In the implementation block
@property (assign,setter=_setCurrentDominantPhysicalButton:,nonatomic) long long _currentDominantPhysicalButton;                                                                             //@synthesize _currentDominantPhysicalButton=__currentDominantPhysicalButton - In the implementation block
@property (nonatomic,readonly) CMKMotionController * _motionController;                                                                                                                      //@synthesize _motionController=__motionController - In the implementation block
...
-(CMKPhysicalCaptureRecognizer *)physicalCaptureRecognizer;
...
-(void)setPhysicalCaptureRecognizer:(CMKPhysicalCaptureRecognizer *)arg1 ;
...
-(CMKAvalancheIndicatorView *)_avalancheIndicator;
-(CMKExposureBiasTextView *)_exposureBiasTextView;
...
-(CMKTimerIndicatorView *)_timerIndicator;
...
-(CMKShutterIndicatorView *)_shutterIndicator;
...
-(CMKDisabledModeOverlayView *)_disabledModeOverlayView;
-(CMKSlalomIndicatorView *)_slalomIndicator;
-(CMKHardwareLockIndicatorView *)_hardwareLockIndicator;
-(CMKBlurredSnapshotView *)_suspensionSnapshotView;
-(CMKBlurredSnapshotView *)_captureSnapshotView;
-(BOOL)_switchingBetweenCameras;
-(CMKBlurredSnapshotView *)_currentDeviceFrontSnapshotView;
-(CMKBlurredSnapshotView *)_currentDeviceBackSnapshotView;
-(CMKBlurredSnapshotView *)_targetDeviceSnapshotView;
-(CMKBlurredSnapshotView *)_modeSwitchingSnapshotView;
...
-(CMKAnimationDelegate *)_delayedCaptureAnimationDelegate;
...
-(CMKPreviewView *)previewView;
-(id)videoPreviewView;
-(CMKMotionController *)_motionController;
...
-(CMKTorchPatternController *)_torchPatternController;
...
-(CMKBottomBar *)_bottomBar;
-(CMKFlashBadge *)_flashBadge;
-(CMKHDRBadge *)_HDRBadge;
