...
@interface IAPTransportServer : NSObject <IAPWorkspaceObserverDelegate> {
	...
	long long _initAccPowerTimerOnce;
	NSObject*<OS_dispatch_source> _accPowerForPortServiceTimer;
	long long _initAccPowerForPortServiceTimerOnce;
	NSObject*<OS_dispatch_source> _ioAccMgrPortDetectTimer;
	long long _initIOAccMgrPortDetectTimerOnce;
	int _iDeviceClass;
	...
	unsigned long long _deviceUUIDTimestampMs;
	BOOL _previousPortListDidContainItems;
...
@property (nonatomic,readonly) NSObject*<OS_dispatch_queue> shutdownQ;                                                                                   //@synthesize shutdownQ=_shutdownQ - In the implementation block
...
-(NSObject*<OS_dispatch_queue>)shutdownQ;
...
-(BOOL)createNewClientPort:(id)arg1 connection:(id)arg2 ;
