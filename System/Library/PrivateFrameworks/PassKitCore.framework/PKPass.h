...
@class NSString, NSDate, NSDictionary, NSURL, NSNumber, NSSet, PKNFCPayload, PKImage, PKBarcode, NSData, PKPaymentPass, UIImage, PKPassDisplayProfile, NSArray, PKPassPersonalization;
