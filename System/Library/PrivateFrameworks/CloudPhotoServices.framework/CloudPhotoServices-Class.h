...
+(void)resizeImageAtURL:(id)arg1 destinationURL:(id)arg2 maximumPixelCount:(long long)arg3 bakeInOrientation:(BOOL)arg4 completionHandler:(/*^block*/id)arg5 ;
...
+(void)resizeImageAtURL:(id)arg1 destinationURL:(id)arg2 maximumPixelCount:(long long)arg3 bakeInOrientation:(BOOL)arg4 convertToSRGB:(BOOL)arg5 completionHandler:(/*^block*/id)arg6 ;
+(long long)terminate;
@end
