...
@class HDDatabaseJournal, HDDaemon, NSString, HDSQLiteDatabasePool, HDContentProtectionManager, NSLock, NSHashTable, NSOperationQueue, NSObject, NSMutableArray, NSMutableDictionary;
