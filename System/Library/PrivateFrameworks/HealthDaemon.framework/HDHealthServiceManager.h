...
-(unsigned long long)connectHealthService:(id)arg1 healthDatabase:(id)arg2 sessionHandler:(/*^block*/id)arg3 transitoryHandler:(/*^block*/id)arg4 characteristicsHandler:(/*^block*/id)arg5 error:(id*)arg6 ;
...
-(unsigned long long)connectHealthService:(id)arg1 healthDatabase:(id)arg2 sessionHandler:(/*^block*/id)arg3 error:(id*)arg4 ;
