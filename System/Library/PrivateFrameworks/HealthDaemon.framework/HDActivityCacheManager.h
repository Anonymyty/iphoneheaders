...
@class NSObject, _HKTimePeriod, HKActivityCache, HDSourceEntity, HDActivityCacheDataSource, HKQuantityType, NSSet, HKQuantitySample, _HKDelayedOperation, NSHashTable, NSDate, NSTimeZone, NSCalendar, NSString;
