...
@class HDSQLitePredicate, _HKFilter, HDActivitySummaryBuilder, NSMutableDictionary, NSObject, NSString;
...
-(id)initWithHealthDaemon:(id)arg1 filter:(id)arg2 initialResultsHandler:(/*^block*/id)arg3 updateHandler:(/*^block*/id)arg4 ;
