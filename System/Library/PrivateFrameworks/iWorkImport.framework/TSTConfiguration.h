...
@property (assign,nonatomic) BOOL controlCellUIAlwaysVisible; 
...
@property (assign,nonatomic) BOOL formulaEditorEvaluatesFormulas; 
@property (assign,nonatomic) BOOL showReferenceHighlightsOnFormulaCellSelection; 
@property (assign,nonatomic) BOOL tokenizeFormulaStringLiterals; 
@property (assign,nonatomic) BOOL exportsCellComments; 
@property (assign,nonatomic) BOOL exportsCellAnnotations; 
@property (assign,nonatomic) BOOL cellEditorsCanScrollToNonLocalTableSelection; 
@property (assign,nonatomic) BOOL formulaCellEditorSupportsTextTokenEditor; 
@property (assign,nonatomic) BOOL supportsRepeatHeaderRowsOnEachPage; 
@property (assign,nonatomic) BOOL supportsTableTranspose; 
@property (assign,nonatomic) BOOL disableImplicitNaming; 
@property (assign,nonatomic) BOOL supportsComplexReorganizeUI; 
@property (assign,nonatomic) BOOL supportsQuickFilterUI; 
@property (assign,nonatomic) BOOL pasteFilterHidingAsUserHiding; 
@property (assign,nonatomic) BOOL allowsFullyFilteredTables; 
@property (assign,nonatomic) BOOL supportsTableColumnAutocomplete; 
@property (assign,nonatomic) BOOL supportsInlineAttachments; 
@property (assign,nonatomic) BOOL followsLinksOnFirstTap; 
@property (assign,nonatomic) BOOL supportsBidiTablesUI; 
