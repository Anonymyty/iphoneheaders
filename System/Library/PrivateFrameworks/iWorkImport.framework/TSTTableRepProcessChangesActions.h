...
@interface TSTTableRepProcessChangesActions : NSObject {
	...
	TSUColumnRowRect _dirtyCellRange;
	TSUColumnRowRect _dirtyStrokeRange;

}

@property (assign,nonatomic) TSUColumnRowRect dirtyCellRange;                //@synthesize dirtyCellRange=_dirtyCellRange - In the implementation block
@property (assign,nonatomic) TSUColumnRowRect dirtyStrokeRange;              //@synthesize dirtyStrokeRange=_dirtyStrokeRange - In the implementation block
...
-(void)setDirtyCellRange:(TSUColumnRowRect)arg1 ;
-(void)setDirtyStrokeRange:(TSUColumnRowRect)arg1 ;
-(TSUColumnRowRect)dirtyCellRange;
-(TSUColumnRowRect)dirtyStrokeRange;
