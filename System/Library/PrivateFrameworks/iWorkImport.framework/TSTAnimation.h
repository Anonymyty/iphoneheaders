...
+(id)newAnimationWithLayout:(id)arg1 andCellRange:(TSUColumnRowRect)arg2 ;
...
-(BOOL)isHidingContentOfCellID:(SCD_Struct_TS315)arg1 ;
...
-(TSUColumnRowRect)cellRangeAtIndex:(unsigned long long)arg1 ;
-(BOOL)drawTableName;
...
-(BOOL)drawStrokes;
-(void)addCellRange:(TSUColumnRowRect)arg1 ;
