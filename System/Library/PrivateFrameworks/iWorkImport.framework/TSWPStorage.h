...
@property (assign,nonatomic) SCD_Struct_TS315 hyperlinkCellID; 
...
-(long long)pFlipOrDelete:(BOOL)arg1 specialCharacterForObject:(id)arg2 range:(NSRange)arg3 attributeArrayKind:(int)arg4 actionState:(TSWPStorageActionState*)arg5 ;
...
-(id)storageByApplyingCustomFormat:(SCD_Struct_TS59)arg1 ;
...
-(SCD_Struct_TS315)hyperlinkCellID;
-(BOOL)changesWithPageCount;
-(void)stashBroadcaster;
-(void)unstashBroadcaster;
-(void)setHyperlinkCellID:(SCD_Struct_TS315)arg1 ;
...
-(NSRange)rangeForCellID:(SCD_Struct_TS315)arg1 includingBreak:(BOOL)arg2 ;
...
-(NSRange)p_replaceCharactersInLogicalSelection:(id)arg1 withString:(id)arg2 withFlags:(unsigned)arg3 replaceTextData:(SCD_Struct_TS648*)arg4 changeSession:(id)arg5 undoTransaction:(TSWPStorageTransaction*)arg6 outInsertedRange:(NSRange*)arg7 ;
...
-(unsigned long long)listNumberForParagraphEnumerator:(const TSWPParagraphEnumerator*)arg1 numberingData:(SCD_Struct_TS649*)arg2 ;
...
-(NSRange)replaceCharactersInSelection:(id)arg1 withString:(id)arg2 withFlags:(unsigned)arg3 replaceTextData:(SCD_Struct_TS648*)arg4 changeSession:(id)arg5 undoTransaction:(TSWPStorageTransaction*)arg6 outInsertedRange:(NSRange*)arg7 ;
...
-(unsigned long long)listNumberForParagraphIndex:(unsigned long long)arg1 numberingData:(SCD_Struct_TS649*)arg2 ;
