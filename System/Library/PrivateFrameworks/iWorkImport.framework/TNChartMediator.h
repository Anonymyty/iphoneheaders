...
-(SCD_Struct_TS683)recalculateForCalculationEngine:(id)arg1 formulaID:(SCD_Struct_TS320)arg2 isInCycle:(BOOL)arg3 hasCalculatedPrecedents:(BOOL)arg4 ;
...
-(BOOL)p_tableHasRange:(SCD_Struct_TS318*)arg1 withCalcEngine:(id)arg2 ;
...
-(id)expandSingleRangeForProposedCategoryLabels:(SCD_Struct_TS318*)arg1 ;
-(BOOL)p_tableHasCell:(SCD_Struct_TS319*)arg1 withCalcEngine:(id)arg2 ;
