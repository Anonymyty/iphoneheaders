...
@class TSKAccessController, TSKChangeNotifier, TSCEUUidReferenceMap, TSCERewriteTableIDInfo, NSString, NSDate, NSTimeZone, NSObject, NSMutableArray, TSCENamedReferenceManager, TSKChangeGroup, TSCETransaction;
...
-(BOOL)rangeIsWithinTable:(SCD_Struct_TS318*)arg1 ;
-(id)documentLocale;
...
-(void)cellReferenceIsDirty:(const SCD_Struct_TS319*)arg1 ;
...
-(void)p_enqueueTaskForCell:(SCD_Struct_TS319*)arg1 ;
-(void)p_recalcOneCellHoldingReadLock:(SCD_Struct_TS319*)arg1 formulaOwner:(id)arg2 hasExistingCalculatedPrecedents:(BOOL)arg3 isInACycle:(BOOL)arg4 ;
-(SCD_Struct_TS319*)p_refillRecalcQueue;
...
-(void)replaceFormula:(SCD_Struct_TS320)arg1 inOwner:(CFUUIDRef)arg2 precedentIterator:(/*function pointer*/void*)arg3 userData:(void*)arg4 ;
-(void)replaceFormula:(SCD_Struct_TS320)arg1 inOwner:(CFUUIDRef)arg2 precedentIterator:(/*function pointer*/void*)arg3 userData:(void*)arg4 clearCycle:(BOOL)arg5 ;
-(void)randomVolatileFunctionsAreDirty;
-(BOOL)isCellReferenceDirty:(SCD_Struct_TS319*)arg1 ;
-(void)headerStateOfTableChanged:(CFUUIDRef)arg1 changeIsForColumns:(BOOL)arg2 ;
-(void)rangeReferenceIsDirty:(SCD_Struct_TS318*)arg1 ;
...
-(id)p_stringForRangeReference:(SCD_Struct_TS318*)arg1 hostTableID:(CFUUIDRef)arg2 contextSheetName:(id)arg3 stickyBits:(unsigned char)arg4 isRangeWithFunction:(BOOL)arg5 quoteComponents:(BOOL)arg6 forceEscaping:(BOOL)arg7 ;
-(id)namedReferenceManager;
-(SCD_Struct_TS315)parseStringAsGeometricReferenceComponent:(id)arg1 inResolver:(id)arg2 outStickyBits:(char*)arg3 gettingReferencesMatchingInputAsPrefix:(id*)arg4 ;
-(SCD_Struct_TS318*)parseStringAsReferenceComponentIntersection:(id)arg1 inResolver:(id)arg2 inTableNamed:(id)arg3 preferredGeometricResolver:(id)arg4 defaultResolver:(id)arg5 outStickyBits:(char*)arg6 gettingReferencesMatchingInputAsPrefix:(id*)arg7 requireFullMatches:(BOOL)arg8 filterColons:(BOOL)arg9 outNamesUsed:(BOOL*)arg10 abortObject:(id)arg11 ;
-(SCD_Struct_TS318*)parseStringAsReference:(id)arg1 tableName:(id)arg2 rest:(id)arg3 contextResolver:(id)arg4 contextSheetName:(id)arg5 gettingReferencesMatchingInputAsPrefix:(id*)arg6 gettingStickyBits:(char*)arg7 filterColons:(BOOL)arg8 referenceIsComplete:(BOOL)arg9 outNamesUsed:(BOOL*)arg10 abortObject:(id)arg11 ;
-(BOOL)parseComponentsOfReference:(id)arg1 gettingSheetName:(id*)arg2 gettingTableName:(id*)arg3 gettingRest:(id*)arg4 ;
-(SCD_Struct_TS318*)parseStringAsReference:(id)arg1 contextResolver:(id)arg2 contextSheetName:(id)arg3 gettingSpecifiedSheetName:(id*)arg4 gettingSpecifiedTableName:(id*)arg5 gettingRest:(id*)arg6 gettingReferencesMatchingInputAsPrefix:(id*)arg7 gettingStickyBits:(char*)arg8 filterColons:(BOOL)arg9 referenceIsComplete:(BOOL)arg10 outNamesUsed:(BOOL*)arg11 abortObject:(id)arg12 ;
...
-(id)openTransaction;
-(void)addFormula:(SCD_Struct_TS320)arg1 inOwner:(CFUUIDRef)arg2 precedentIterator:(/*function pointer*/void*)arg3 userData:(void*)arg4 ;
-(void)removeFormula:(SCD_Struct_TS320)arg1 inOwner:(CFUUIDRef)arg2 ;
-(void)removeAllFormulasFromOwner:(CFUUIDRef)arg1 ;
-(void)removeFormulasFromRange:(SCD_Struct_TS318*)arg1 ;
-(void)setError:(id)arg1 forCell:(const SCD_Struct_TS319*)arg2 ;
-(void)clearErrorForCell:(const SCD_Struct_TS319*)arg1 ;
-(SCD_Struct_TS319*)rootCauseForErrorInCell:(const SCD_Struct_TS319*)arg1 atRootCell:(BOOL*)arg2 ;
-(void)foreachFormulaInOwner:(CFUUIDRef)arg1 block:(/*^block*/id)arg2 ;
-(vector<TSUColumnRowCoordinate, std::__1::allocator<TSUColumnRowCoordinate> >*)formulaCoordsReferringToRange:(const SCD_Struct_TS318*)arg1 fromOwner:(CFUUIDRef)arg2 ;
-(vector<TSUColumnRowCoordinate, std::__1::allocator<TSUColumnRowCoordinate> >*)formulaCoordsInRange:(const TSCERangeCoordinate*)arg1 inOwner:(CFUUIDRef)arg2 ;
-(unsigned long long)dirtyCellCountInOwner:(CFUUIDRef)arg1 ;
-(BOOL)cellIsInACycle:(SCD_Struct_TS319*)arg1 ;
-(BOOL)referenceWasGuaranteedCleanAtRecalcCycleStart:(TSCECReference*)arg1 ;
-(BOOL)clearCellIsDirtyAfterRecalc:(SCD_Struct_TS319*)arg1 ;
...
-(void)markOnlyDependentsDirty:(const SCD_Struct_TS319*)arg1 ;
...
-(BOOL)cellContainsAFormula:(SCD_Struct_TS319*)arg1 ;
...
-(SCD_Struct_TS315)cellCoordForCellHandle:(SCD_Struct_TS315)arg1 inTable:(CFUUIDRef)arg2 ;
-(TSCERangeCoordinate)rangeCoordForCellHandleRange:(TSCERangeCoordinate)arg1 inTable:(CFUUIDRef)arg2 ;
-(SCD_Struct_TS315)cellHandleForCellCoord:(SCD_Struct_TS315)arg1 inTable:(CFUUIDRef)arg2 ;
-(TSCERangeCoordinate)cellHandleRangeForRangeCoord:(TSCERangeCoordinate)arg1 inTable:(CFUUIDRef)arg2 ;
-(BOOL)referenceIsValid:(SCD_Struct_TS318*)arg1 ;
-(id)stringForRangeReference:(SCD_Struct_TS318*)arg1 hostTableID:(CFUUIDRef)arg2 stickyBits:(unsigned char)arg3 isRangeWithFunction:(BOOL)arg4 ;
-(id)stringForRangeReference:(SCD_Struct_TS318*)arg1 contextSheetName:(id)arg2 stickyBits:(unsigned char)arg3 isRangeWithFunction:(BOOL)arg4 ;
-(id)escapedStringForRangeReference:(SCD_Struct_TS318*)arg1 hostTableID:(CFUUIDRef)arg2 stickyBits:(unsigned char)arg3 isRangeWithFunction:(BOOL)arg4 forceEscaping:(BOOL)arg5 ;
-(id)escapedStringForRangeReference:(SCD_Struct_TS318*)arg1 contextSheetName:(id)arg2 stickyBits:(unsigned char)arg3 isRangeWithFunction:(BOOL)arg4 forceEscaping:(BOOL)arg5 ;
-(unordered_set<TSCECReference, TSCECReferenceHash, TSCECReferenceEqual, std::__1::allocator<TSCECReference> >*)precedentsOfCell:(SCD_Struct_TS319*)arg1 ;
-(SCD_Struct_TS318*)parseStringAsReference:(id)arg1 tableName:(id)arg2 rest:(id)arg3 contextResolver:(id)arg4 contextSheetName:(id)arg5 gettingReferencesMatchingInputAsPrefix:(id*)arg6 gettingStickyBits:(char*)arg7 filterColons:(BOOL)arg8 referenceIsComplete:(BOOL)arg9 outNamesUsed:(BOOL*)arg10 ;
-(SCD_Struct_TS318*)parseStringAsReference:(id)arg1 contextResolver:(id)arg2 contextSheetName:(id)arg3 gettingSpecifiedSheetName:(id*)arg4 gettingSpecifiedTableName:(id*)arg5 gettingRest:(id*)arg6 gettingReferencesMatchingInputAsPrefix:(id*)arg7 gettingStickyBits:(char*)arg8 filterColons:(BOOL)arg9 referenceIsComplete:(BOOL)arg10 outNamesUsed:(BOOL*)arg11 ;
