...
@class CALayer, CAShapeLayer, TSWPSelection, TSWPSearchReference, TSWPEditingController, NSArray, TSWPLayout, TSWPStorage;
...
-(SCD_Struct_TS652)lineMetricsAtCharIndex:(unsigned long long)arg1 ;
...
-(SCD_Struct_TS652)lineMetricsAtPoint:(CGPoint)arg1 ;
-(SCD_Struct_TS662)wordMetricsAtCharIndex:(unsigned long long)arg1 ;
