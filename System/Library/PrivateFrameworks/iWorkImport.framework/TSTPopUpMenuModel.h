...
-(SCD_Struct_TS61)formatAtIndex:(unsigned long long)arg1 ;
-(id)popUpItemFromDate:(id)arg1 format:(SCD_Struct_TS61)arg2 ;
-(id)popUpItemFromNumber:(double)arg1 format:(SCD_Struct_TS61)arg2 ;
