...
@class NSUUID, NSString, KNBuildAttributes, TSDDrawableInfo, NSArray, NSMutableDictionary, KNAbstractSlide, KNAnimationInfo, KNAnimationPluginMenu, KNBuildChunk, TSUColor, TSDEditableBezierPathSource, TSDBezierPathSource, NSSet;
