...
@interface TSCH3Dvec3DataBuffer : TSCH3DFloatVectorDataBuffer {
	...
	vector<glm::detail::tvec3<float>, std::__1::allocator<glm::detail::tvec3<float> > >* mContainer;

}

@property (nonatomic,readonly) vector<glm::detail::tvec3<float>* container; 
...
-(const void*)data;
-(vector<glm::detail::tvec3<float>*)container;
-(void)clear;
