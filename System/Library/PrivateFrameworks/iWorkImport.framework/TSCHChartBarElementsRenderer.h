...
-(SCD_Struct_TS448)p_valueRangeForModelCache:(id)arg1 groupIndex:(unsigned long long)arg2 ;
-(CGRect)renderingElementFrameForBarElementFrame:(CGRect)arg1 groupIndex:(unsigned long long)arg2 modelCache:(id)arg3 stroke:(id)arg4 viewScale:(double)arg5 contextInfo:(SCD_Struct_TS449)arg6 returningFillRect:(CGRect*)arg7 strokeRect:(CGRect*)arg8 ;
