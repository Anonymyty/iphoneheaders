...
@interface TSTWPLayout : TSWPLayout {
	...
	BOOL _cacheIsValid;
	SCD_Struct_TS315 _cachedCellID;
	...
	TSUColumnRowRect _cachedMergeRange;
	TSUColumnRowRect _cachedMaskSpillRange;
...
@property (assign,nonatomic) SCD_Struct_TS315 cachedCellID;                      //@synthesize cachedCellID=_cachedCellID - In the implementation block
...
@property (assign,nonatomic) TSUColumnRowRect cachedMergeRange;                  //@synthesize cachedMergeRange=_cachedMergeRange - In the implementation block
...
@property (assign,nonatomic) TSUColumnRowRect cachedMaskSpillRange;              //@synthesize cachedMaskSpillRange=_cachedMaskSpillRange - In the implementation block
...
-(SCD_Struct_TS315)cachedCellID;
-(TSUColumnRowRect)cachedMergeRange;
...
-(id)initWithStorage:(id)arg1 parentLayout:(id)arg2 cellID:(SCD_Struct_TS315)arg3 frame:(CGRect)arg4 ;
...
-(void)setCachedMaskSpillRange:(TSUColumnRowRect)arg1 ;
...
-(void)setCachedMergeRange:(TSUColumnRowRect)arg1 ;
...
-(void)setCachedCellID:(SCD_Struct_TS315)arg1 ;
-(TSUColumnRowRect)cachedMaskSpillRange;
-(void)dealloc;
-(void)invalidate;
-(void)validate;
@end
