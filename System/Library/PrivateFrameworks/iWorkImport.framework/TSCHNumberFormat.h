...
+(id)numberFormatWithFormatStruct:(SCD_Struct_TS61)arg1 prefixString:(id)arg2 suffixString:(id)arg3 ;
...
-(id)initWithFormatStruct:(SCD_Struct_TS61)arg1 prefixString:(id)arg2 suffixString:(id)arg3 ;
-(id)p_initWithFormatStruct:(SCD_Struct_TS61)arg1 prefixString:(id)arg2 suffixString:(id)arg3 ;
