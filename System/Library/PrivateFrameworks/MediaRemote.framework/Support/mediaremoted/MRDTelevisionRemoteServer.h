...
@class MRDTelevisionServerNetworkService, NSRunLoop, NSMutableSet, NSObject, MRDSystemHIDEventManager, MRDTelevisionStateObserver, MRDTelevisionGameControllerServer, MRDPinPairingDialog, MRDNowPlayingDataSource, NSString;

@interface MRDTelevisionRemoteServer : NSObject <NSStreamDelegate, MRCryptoPairingSessionDelegate, MRDTelevisionServerNetworkServiceDelegate, MRDTelevisionStateObserverDelegate, MRDTelevisionTextEditingServiceDelegate, MRTelevisionClientConnectionDelegate, MRDTelevisionGameControllerServerDelegate, MRDXPCMessageHandling> {
...
-(void)_handleReceivedHIDEvent:(IOHIDEventRef)arg1 fromClient:(id)arg2 ;
...
-(void)_handleClientReady:(id)arg1 ;
