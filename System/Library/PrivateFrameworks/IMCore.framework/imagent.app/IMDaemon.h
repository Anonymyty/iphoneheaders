...
-(void)loadUnreadForIDs:(id)arg1 style:(unsigned char)arg2 onServices:(id)arg3 limit:(unsigned long long)arg4 fallbackGUID:(id)arg5 chatId:(id)arg6 queryID:(id)arg7 messageContext:(id)arg8 ;
...
-(void)markReadForIDs:(id)arg1 style:(unsigned char)arg2 onServices:(id)arg3 messages:(id)arg4 clientUnreadCount:(unsigned long long)arg5 messageContext:(id)arg6 ;
...
-(void)chat:(id)arg1 updateIsFiltered:(BOOL)arg2 messageContext:(id)arg3 ;
