...
-(BOOL)updatePairedDeviceWithCBUUID:(id)arg1 deviceUniqueID:(id)arg2 buildVersion:(id)arg3 productVersion:(id)arg4 productName:(id)arg5 pairingProtocolVersion:(unsigned)arg6 minCompatibilityVersion:(unsigned)arg7 maxCompatibilityVersion:(unsigned)arg8 ;
...
-(BOOL)_criticalUpdatePairedDeviceWithCBUUID:(id)arg1 deviceUniqueID:(id)arg2 buildVersion:(id)arg3 productVersion:(id)arg4 productName:(id)arg5 pairingProtocolVersion:(unsigned)arg6 minCompatibilityVersion:(unsigned)arg7 maxCompatibilityVersion:(unsigned)arg8 ;
