...
+(BOOL)_shouldReplaceLocalDestination:(id)arg1 ;
...
-(void)_processStoredMessagesIncludingClassD:(BOOL)arg1 ;
...
-(BOOL)_canSendMessageWithAccount:(id)arg1 toDestinations:(id)arg2 ;
-(BOOL)_shouldIncludeDefaultDeviceAsDestinationForMessageForFromID:(id)arg1 service:(id)arg2 ;
...
-(BOOL)_validateListenerForLocalPairingWithMessageContext:(id)arg1 error:(id*)arg2 ;
...
-(void)iCloudSignInWithUserName:(id)arg1 authToken:(id)arg2 password:(id)arg3 accountInfo:(id)arg4 accountStatus:(id)arg5 messageContext:(id)arg6 ;
...
-(BOOL)_setupListenerConnection:(id)arg1 listenerID:(id)arg2 pid:(int)arg3 setupInfo:(id)arg4 entitlements:(id)arg5 setupCompletionBlock:(/*^block*/id)arg6 ;
