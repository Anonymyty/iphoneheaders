...
@class SUViewController, _UIBackdropView, ISURLRequestPerformance, NSString, SUStorePageProtocol, UIPopoverController, SUNavigationMenuViewController, SUSearchFieldController, SSAuthenticationContext, SSMutableURLRequestProperties, SUPageSectionGroup, SUSegmentedControl, SSURLRequestProperties;
