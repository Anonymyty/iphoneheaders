...
-(void)removeDownloadsWithIdentifiers:(id)arg1 canceled:(BOOL)arg2 ;
-(long long)addLibraryItem:(id)arg1 error:(id*)arg2 ;
-(BOOL)_addLibraryItems:(id)arg1 toMusicLibrary:(id)arg2 itemPids:(long long*)arg3 error:(id*)arg4 ;
-(void)_commitScheduledLibraryItems;
-(BOOL)_removeDownloadWithIdentifier:(long long)arg1 canceled:(BOOL)arg2 inLibrary:(id)arg3 ;
...
-(void)removeDownloadWithIdentifier:(long long)arg1 canceled:(BOOL)arg2 ;
