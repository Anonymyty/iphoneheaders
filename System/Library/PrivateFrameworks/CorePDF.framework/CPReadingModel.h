...
@interface CPReadingModel : NSObject {
	...
	long long _count;
	SCD_Struct_CP16* _textLineRanges;
	SCD_Struct_CP16* _stringLineRanges;
	long long* _pageNumbers;
	SCD_Struct_CP16 _pageRange;
	...
	SCD_Struct_CP16 _textRangeMemo;
	NSRange _rangeMemo;
	RMList* _currentList;
...
-(CGRect)pdfBoundsForNewLine:(SCD_Struct_CP16)arg1 ;
-(SCD_Struct_CP16)mapStringRange:(NSRange)arg1 ;
...
-(void)addRange:(SCD_Struct_CP16)arg1 ;
...
-(SCD_Struct_CP16)textRangeForStringRange:(NSRange)arg1 ;
-(NSRange)stringRangeForTextRange:(SCD_Struct_CP16)arg1 onPageNumber:(unsigned long long)arg2 ;
-(NSRange)pageRangeForStringRange:(SCD_Struct_CP16)arg1 ;
