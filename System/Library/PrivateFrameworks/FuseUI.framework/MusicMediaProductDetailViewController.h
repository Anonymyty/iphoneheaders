...
@class MPArtworkCatalog, UIBarButtonItem, MusicMediaProductDetailHeaderConfiguration, MusicEntityProviderDownloadInformationController, MusicMediaProductHeaderContentViewController, MusicMediaDetailHeaderViewController, NSArray, NSMutableArray, UIViewController, MusicTransferAggregator, MusicEntityValueContext, MusicClientContext, UIImage, MusicMediaProductSplitDetailViewController, MusicMediaProductSplitMainViewController, UIScrollView, NSString;
