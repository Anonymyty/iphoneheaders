...
#import <libobjc.A.dylib/MusicJSNowPlayingNativeViewControllerDelegate.h>
#import <libobjc.A.dylib/MusicNowPlayingItemViewControllerDelegate.h>
#import <libobjc.A.dylib/MusicNowPlayingVolumeSliderDelegate.h>
...
@class MPAVItem, MPAudioVideoRoutingPopoverController, MPAVRoutingSheet, NSTimer, UITapGestureRecognizer, UIPanGestureRecognizer, UIPinchGestureRecognizer, MusicNowPlayingPresentationController, NSArray, MusicClientContext, MPAVController, MusicNowPlayingFloatingButton, MusicNowPlayingItemViewController, MusicPlaybackProgressSliderView, MusicNowPlayingTitlesView, MPUTransportControlsView, MusicNowPlayingVolumeSlider, UIView, UIViewController, MPUBlurEffectView, MPUVibrantContentEffectView, MPUSkipLimitView, MPUGradientView, MusicPlaybackProgressScrubberController, MPUTransportControlMediaRemoteController, RUTrackDownloadView, NSString, SKUIClientContext;
...
-(void)_peekSkipLimit:(SCD_Struct_Mu25)arg1 ;
