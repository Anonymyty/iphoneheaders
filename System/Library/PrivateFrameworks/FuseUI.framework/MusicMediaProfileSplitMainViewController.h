...
@property (assign,nonatomic) double preferredMaximumContentWidth;                                                                       //@synthesize preferredMaximumContentWidth=_preferredMaximumContentWidth - In the implementation block
...
@property (assign,getter=isVisuallyInset,nonatomic) BOOL visuallyInset;                                                                 //@synthesize visuallyInset=_visuallyInset - In the implementation block
