...
@class MPUTextButton, UIView, _UIBackdropView, MusicNowPlayingFloatingButton, NSString, UILabel, UITextView, UIButton, UIActivityIndicatorView, MusicDownloadProgressButton, MusicEntityViewProductHeaderLockupContentDescriptor;
