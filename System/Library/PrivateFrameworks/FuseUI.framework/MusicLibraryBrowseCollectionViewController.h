...
@class MusicAsynchronousPropertyLoadingController, MusicCollectionView, MusicLibraryBrowseCollectionViewConfiguration, MusicEntityDownloadInformationController, MusicEntityCollectionViewDescriptor, SKUIDynamicPageSectionIndexMapper, MusicEntityValueContext, MusicLibraryBrowseCollectionViewLayoutMetrics, MusicEntityPlayabilityController, MusicEntityPlaybackStatusController, MPAVController, NSMutableArray, MusicSectionEntityValueContext, NSMapTable, NSString, MusicClientContext, UICollectionView, UICollectionViewFlowLayout, SKUIClientContext;
