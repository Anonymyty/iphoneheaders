...
@property (assign,nonatomic) BOOL shouldRestartDaemon;                                               //@synthesize shouldRestartDaemon=_shouldRestartDaemon - In the implementation block
@property (nonatomic,retain) NSObject*<OS_dispatch_queue> shouldRestartDaemonQueue;                  //@synthesize shouldRestartDaemonQueue=_shouldRestartDaemonQueue - In the implementation block
...
-(NSObject*<OS_dispatch_queue>)shouldRestartDaemonQueue;
...
-(void)setShouldRestartDaemon:(BOOL)arg1 ;
...
-(void)_pingActiveGizmoWithPriority:(long long)arg1 withBlock:(/*^block*/id)arg2 ;
...
-(void)setShouldRestartDaemonQueue:(NSObject*<OS_dispatch_queue>)arg1 ;
