...
@interface CUIShapeEffectStack : NSObject {
	...
	SCD_Struct_CU31 colorOverlay;
	BOOL hasInnerGradient;
	SCD_Struct_CU32 innerGradient;
	BOOL hasInnerGlow;
	SCD_Struct_CU33 innerGlow;
	BOOL hasInnerShadow;
	SCD_Struct_CU34 insideShadow;
	BOOL hasOuterGlow;
	SCD_Struct_CU35 outerGlow;
	BOOL hasEngraveShadow;
	SCD_Struct_CU36 engraveShadow;
	BOOL hasExtraShadow;
	SCD_Struct_CU36 extraShadow;
	BOOL hasBevelEmboss;
	SCD_Struct_CU37 emboss;
	float scalefactor;
	int renderStrategy;
...
+(id)gradientWithParameters:(SCD_Struct_CU32*)arg1 inRect:(CGRect)arg2 ;
