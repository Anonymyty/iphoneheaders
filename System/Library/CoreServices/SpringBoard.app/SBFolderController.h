...
@property (assign,nonatomic,__weak) id<SBFolderControllerDelegate> delegate;                     //@synthesize delegate=_delegate - In the implementation block
...
@property (assign,nonatomic,__weak) SBFolderController * outerFolderController;                  //@synthesize outerFolderController=_outerFolderController - In the implementation block
