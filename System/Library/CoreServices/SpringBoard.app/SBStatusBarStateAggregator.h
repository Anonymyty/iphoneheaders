...
@class NSHashTable, NSDateFormatter, NSTimer, NSString, NSArray, SBSStatusBarStyleOverridesAssertion, SBUserSessionController;
...
-(void)dealloc;
-(id)init;
-(const SCD_Struct_SB45*)_statusBarData;
-(id)operatorName;
