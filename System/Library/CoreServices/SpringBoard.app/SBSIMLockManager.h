...
@property (assign,nonatomic,__weak) SBSIMLockAlertItem * currentAlert;              //@synthesize currentAlert=_currentAlert - In the implementation block
+(id)sharedInstance;
...
-(SBSIMLockAlertItem *)currentAlert;
-(void)setCurrentAlert:(SBSIMLockAlertItem *)arg1 ;
