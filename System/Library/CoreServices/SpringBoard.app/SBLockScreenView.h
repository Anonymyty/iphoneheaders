...
@protocol SBUILegibility, _SBFVibrantView, SBUILegibility_SBFVibrantView, SBUIPasscodeLockView, SBPresentingDelegate, SBLockScreenViewDelegate;
@class NSSet, SBLockOverlayStylePropertiesFactory, NSMutableSet, NSMutableArray, UIView, _UIBackdropView, SBLockScreenScrollView, SBFLockScreenDateView, SBLockScreenTimerView, _UIGlintyStringView, NSCountedSet, SBWallpaperEffectView, SBChevronView, SBSlideUpAppGrabberView, SBLockScreenBatteryChargingView, SBUIVibrantButton, SBLockScreenDeviceInformationTextView, SBLockScreenViewRequesterTracker, SBLockScreenBounceAnimator, SBFakeStatusBarView, SBDisableAppStatusBarAlphaChangesAssertion, SBAppStatusBarSettingsAssertion, SBSlideToUnlockFailureRecognizer, SBIrisWallpaperSettings, UIGestureRecognizer, _UILegibilitySettings, UIColor, UIScrollView, NSString;
...
@interface SBLockScreenView : SBAlertView <UIScrollViewDelegate, _UIGlintyStringViewDelegate, _UISettingsKeyObserver, SBCoordinatedPresenting, SBPresentingDelegate> {
	...
	SBSlideUpAppGrabberView*<SBUILegibility>*<_SBFVibrantView> _cameraGrabberView;
	SBSlideUpAppGrabberView*<SBUILegibility>*<_SBFVibrantView> _bottomLeftGrabberView;
