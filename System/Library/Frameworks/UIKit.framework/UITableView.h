...
@protocol UITableViewDataSource, UITableViewConstants;
@class UITraitCollection, UITableViewRowData, NSMutableArray, NSMutableDictionary, NSIndexPath, UIView, UITableViewCell, _UITableViewDeleteAnimationSupport, _UITableViewReorderingSupport, UITableViewWrapperView, UITableViewIndex, UITableViewCountView, NSArray, UITableViewIndexOverlayIndicatorView, NSTimer, UITableViewIndexOverlaySelectionView, UIColor, UIVisualEffect, UISwipeGestureRecognizer, UIGobblerGestureRecognizer, UILongPressGestureRecognizer, UITapGestureRecognizer, UITouch, UIRefreshControl, UIImage, NSMutableSet, _UITableViewUpdateSupport, UIWindow, UIFocusContainerGuide, UIScrollView, NSString;
