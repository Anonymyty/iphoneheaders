...
@class WebView, DOMHTMLElement, UIAutoscroll, CALayer, NSArray, UITextInputTraits, UITapGestureRecognizer, _UIWebHighlightLongPressGestureRecognizer, UILongPressGestureRecognizer, UIPanGestureRecognizer, UIPreviewItemController, _UIWebViewportHandler, WebThreadSafeUndoManager, UIWebSelectionAssistant, UITextInteractionAssistant, UITextChecker, UIWebFileUploadPanel, DOMElement, DOMRange, UIWebPlaybackTargetPicker, _UITextServiceSession, WebHistoryItem, NSString, UITextRange, NSDictionary, UITextPosition, UIView, NSIndexSet, UIColor, UIImage;

@interface UIWebDocumentView : UIWebTiledView <UITextAutoscrolling, UIAutoscrollContainer, _UIRotatingAlertControllerDelegate, DDDetectionControllerInteractionDelegate, UIPreviewItemDelegate, UIGestureRecognizerDelegate, UIKeyboardInput, UITextInputPrivate, UIKeyInput, UIModalViewDelegate, UITextInputTokenizer, _UIWebDoubleTapDelegate, UIWebFileUploadPanelDelegate, WebFrameLoadDelegate> {
