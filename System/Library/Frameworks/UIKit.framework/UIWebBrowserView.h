...
@class UIView, NSString, UIWebFormAccessory, NSObject, DOMNode, UIWebTouchEventsGestureRecognizer, UIWebFormDelegate, UIResponder, NSMutableArray, NSHashTable, NSMutableSet, NSLock;

@interface UIWebBrowserView : UIWebDocumentView <WBUFormAutoFillWebView, UIWebTouchEventsGestureRecognizerDelegate, UIWebFormAccessoryDelegate, _UIWebRotationDelegate> {
	...
	SCD_Struct_UI84 _messages;
	SCD_Struct_UI85 _pdf;
