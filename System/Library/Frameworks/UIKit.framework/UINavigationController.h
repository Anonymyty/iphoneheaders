...
@class UIView, UINavigationBar, UIToolbar, UIViewController, UITapGestureRecognizer, NSMapTable, _UINavigationControllerPalette, _UINavigationParallaxTransition, _UINavigationInteractiveTransition, NSUUID, UIFocusContainerGuide, _UIBarPanGestureRecognizer, _UIAnimationCoordinator, _UIBarTapGestureRecognizer, NSString, NSArray, UIGestureRecognizer, UIPanGestureRecognizer, UINavigationTransitionView;
