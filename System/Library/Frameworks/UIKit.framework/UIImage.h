...
+(id)_sbf_imageFromContextWithSize:(CGSize)arg1 scale:(double)arg2 type:(long long)arg3 colorSpace:(CGColorSpaceRef)arg4 pool:(id)arg5 drawing:(/*^block*/id)arg6 encapsulation:(/*^block*/id)arg7 ;
...
-(id)_maps_imageScaledToSize:(CGSize)arg1 ;
...
-(SCD_Struct_UI16)bl_pixelAtX:(int)arg1 y:(int)arg2 sampleSize:(float)arg3 ;
-(float)bl_lumaAtX:(int)arg1 y:(int)arg2 sampleSize:(float)arg3 ;
-(SCD_Struct_UI16)bl_pixelAtX:(int)arg1 y:(int)arg2 ;
...
-(id)_serializedData;
-(void)draw3PartImageWithSliceRects:(SCD_Struct_UI18)arg1 inRect:(CGRect)arg2 operation:(int)arg3 fraction:(double)arg4 ;
...
-(void)draw9PartImageWithSliceRects:(SCD_Struct_UI19)arg1 inRect:(CGRect)arg2 fraction:(double)arg3 ;
-(void)draw9PartImageWithSliceRects:(SCD_Struct_UI19)arg1 inRect:(CGRect)arg2 operation:(int)arg3 fraction:(double)arg4 ;
...
-(void)draw3PartImageWithSliceRects:(SCD_Struct_UI18)arg1 inRect:(CGRect)arg2 fraction:(double)arg3 ;
...
-(void)draw9PartImageWithSliceRects:(SCD_Struct_UI19)arg1 inRect:(CGRect)arg2 ;
-(void)draw3PartImageWithSliceRects:(SCD_Struct_UI18)arg1 inRect:(CGRect)arg2 ;
...
-(SCD_Struct_UI22)_calculateStatistics;
