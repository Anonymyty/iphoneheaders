...
@class NSString, NSAttributedString, NSMutableArray, NSSet, UIAlertAction, NSMutableDictionary, NSMapTable, NSObject, UIViewController, _UIAlertControllerTextFieldViewController, UITapGestureRecognizer, _UIAlertControllerSelectGestureRecognizer, UIView, UIAlertControllerVisualStyle, UIPopoverController, UIGestureRecognizer, _UIAnimationCoordinator, UIPreviewInteractionController, NSArray;
