...
@class UITabBar, UIView, UIViewController, UIMoreNavigationController, NSArray, UITapGestureRecognizer, UIGestureRecognizer, UIFocusContainerGuide, NSMapTable, NSMutableArray, NSString, UINavigationController;
