...
-(CGRect)handwritingPointToRect:(SCD_Struct_UI70)arg1 ;
...
-(void)addTrapezoidFromFirstPoint:(SCD_Struct_UI70)arg1 secondPoint:(SCD_Struct_UI70)arg2 ;
-(void)addHandwritingPoint:(SCD_Struct_UI70)arg1 ;
