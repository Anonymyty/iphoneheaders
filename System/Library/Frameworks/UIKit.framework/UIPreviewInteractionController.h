...
@class UIInteractionProgress, UIView, UIViewController, UIPreviewForceInteractionProgress, _UIRevealGestureRecognizer, _UIPreviewGestureRecognizer, UIGestureRecognizer, UIPresentationController, UIWindow, _UITapticEngine, NSArray, NSString;
