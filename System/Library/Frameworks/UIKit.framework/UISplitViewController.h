...
@class UIBarButtonItem, NSString, UIPopoverController, UIView, UIResponder, UISnapshotView, NSArray, UIGestureRecognizer, UITapGestureRecognizer, UITraitCollection, UIViewController, UIFocusContainerGuide;
