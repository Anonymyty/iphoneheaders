...
#import <Maps/SimpleAlertPresenter.h>
...
@class UIView, UITabBarItem, UINavigationItem, NSArray, NSString, NSBundle, UIResponder, UIStoryboard, NSDictionary, UIBarButtonItem, UISearchDisplayController, UIPopoverController, UIScrollView, NSMapTable, NSMutableArray, UITransitionView, UITraitCollection, UIPresentationController, NSLayoutConstraint, _UILayoutGuide, UIStoryboardSegue, UIWindow, FMSlidingPaneViewController, NSData, _ADUIViewControllerAdController, _UIBackdropView, SKUIScrollingSegmentedController, SKUIScrollingTabBarController, SKUIStackedBar, SUStorePageProtocol, SUViewControllerFactory, PUModalTransition, PUNavigationTransition, PUViewModel, UIToolbar, PUToolbarViewModel, NSExtensionContext, UINavigationController, UISplitViewController, UITabBarController, UIDropShadowView;

@interface UIViewController : UIResponder <SimpleAlertPresenter, GKContentRefresh, GKURLHandling, NSExtensionRequestHandling, _UIViewServiceDeputy, UIViewControllerPresenting, _UITraitEnvironmentInternal, _UIContentContainerInternal, _UIFocusEnvironmentInternal, _UIFocusRegion, NSCoding, UIAppearanceContainer, UITraitEnvironment, UIContentContainer, UIFocusEnvironment> {
	...
	SCD_Struct_UI34 _presentationSizeClassPair;
...
@property (nonatomic,readonly) SCD_Struct_UI34 __sizeClassPair; 
...
@property (assign,setter=_setPresentationSizeClassPair:,getter=_presentationSizeClassPair,nonatomic) SCD_Struct_UI34 presentationSizeClassPair;                                                    //@synthesize presentationSizeClassPair=_presentationSizeClassPair - In the implementation block
...
-(UIWindow *)_maps_containingWindow;
...
-(SCD_Struct_UI34)__sizeClassPair;
...
-(void)_setPresentationSizeClassPair:(SCD_Struct_UI34)arg1 ;
...
-(void)_getRotationContentSettings:(SCD_Struct_UI36*)arg1 ;
...
-(void)getRotationContentSettings:(SCD_Struct_UI36*)arg1 forWindow:(id)arg2 ;
