...
@class UIImageView, _UIStaticScrollBar, UIView, UIScrollViewPinchGestureRecognizer, UIScrollViewDirectionalPressGestureRecognizer, UISwipeGestureRecognizer, NSISVariable, NSArray, ISScrollViewVitalityController, UIPanGestureRecognizer, UIPinchGestureRecognizer, UIGestureRecognizer, NSString;
...
@property (nonatomic,readonly) ISScrollViewVitalityController * is_vitalityController; 
@property (assign,setter=is_setSupportsVitality:,nonatomic) BOOL is_supportsVitality; 
@property (assign,setter=is_setVitalityHints:,nonatomic) unsigned long long is_vitalityHints; 
@property (nonatomic,readonly) id<UIScrollViewDelegate> is_scrollViewDelegate; 
...
-(ISScrollViewVitalityController *)is_vitalityController;
-(void)is_setSupportsVitality:(BOOL)arg1 ;
-(void)is_setVitalityHints:(unsigned long long)arg1 ;
-(id<UIScrollViewDelegate>)is_scrollViewDelegate;
-(void)is_didLayoutPlayerViews;
-(unsigned long long)is_vitalityHints;
-(BOOL)is_supportsVitality;
