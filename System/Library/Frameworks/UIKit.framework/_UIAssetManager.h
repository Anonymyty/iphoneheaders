...
-(id)imageNamed:(id)arg1 scale:(double)arg2 idiom:(long long)arg3 subtype:(unsigned long long)arg4 cachingOptions:(unsigned long long)arg5 sizeClassPair:(SCD_Struct_UI34)arg6 attachCatalogImage:(BOOL)arg7 ;
