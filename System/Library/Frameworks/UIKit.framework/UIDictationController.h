...
@class AFDictationConnection, AFDictationOptions, AFPreferences, NSArray, NSTimer, UIAlertView, UIDictationStreamingOperations, NSString, CADisplayLink, UIRepeatedAction, NSMutableArray, UIWindow, _UIDictationPrivacySheetController, UIKeyboardInputMode;
