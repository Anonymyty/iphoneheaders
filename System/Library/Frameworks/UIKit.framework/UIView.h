...
@class UIBezierPath, UITraitCollection, NSMutableArray, CALayer, NSArray, UIViewController, NSString, UIColor, UILayoutGuide, NSISVariable, NSISEngine, UIPresentationController, UIStoryboardPreviewingSegueTemplateStorage, NSNumber, NAUITextStyleDescriptor, CABasicAnimation, MKMapView, MPArtworkCatalog, CNContactStyle, UIKBRenderConfig, _UITouchForceObservable, NSLayoutXAxisAnchor, NSLayoutYAxisAnchor, NSLayoutDimension;
...
-(void)addDefaultTranslationSpringWithVelocity:(double)arg1 startTime:(double)arg2 ;
-(void)addDefaultTransformSpringWithStartTime:(double)arg1 ;
-(double)_siriMoviesColumnWidthForStyle:(int)arg1 ;
...
-(void)mt_concatPixelAlignedTransform:(CGAffineTransform)arg1 ;
...
-(void)ax_setContentHuggingAndCompressionResistance:(SCD_Struct_UI25)arg1 ;
