...
@property (assign,nonatomic) int resetCounter;                                                          //@synthesize resetCounter=_resetCounter - In the implementation block
...
-(void)resetWithStandardKeyPixelSize:(CGSize)arg1 ;
