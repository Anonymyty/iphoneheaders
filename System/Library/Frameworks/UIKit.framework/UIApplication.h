...
@property (assign,setter=_setGameControllerMenuButtonDelegate:,getter=_gameControllerMenuButtonDelegate,nonatomic,__weak) id<UIApplicationGameControllerMenuButtonDelegate> gameControllerMenuButtonDelegate;              //@synthesize gameControllerMenuButtonDelegate=_gameControllerMenuButtonDelegate - In the implementation block
...
@property (assign,setter=_setCurrentActivityContinuationProgressDisplayingUI:,getter=_isCurrentActivityContinuationDisplayingUI,nonatomic) BOOL currentActivityContinuationProgressDisplayingUI;                           //@synthesize currentActivityContinuationProgressDisplayingUI=_currentActivityContinuationProgressDisplayingUI - In the implementation block
@property (nonatomic,retain) SBSApplicationService * shortcutService;                                                                                                                                                      //@synthesize shortcutService=_shortcutService - In the implementation block
...
-(void)_handleApplicationDeactivationWithScene:(id)arg1 shouldForceExit:(BOOL)arg2 transitionContext:(id)arg3 completion:(/*^block*/id)arg4 ;
...
-(void)_updateSceneGeometryWithSettingObserverContext:(SCD_Struct_UI6)arg1 ;
...
-(void)_updateStateRestorationArchiveForBackgroundEvent:(/*^block*/id)arg1 saveState:(BOOL)arg2 exitIfCouldNotRestoreState:(BOOL)arg3 updateSnapshot:(BOOL)arg4 ;
...
-(SBSApplicationService *)shortcutService;
-(void)setShortcutService:(SBSApplicationService *)arg1 ;
