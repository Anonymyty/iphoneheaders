...
@property (assign,nonatomic) double maximumOverlayDepth;                                                       //@synthesize maximumOverlayDepth=_maximumOverlayDepth - In the implementation block
...
@property (assign,nonatomic) double scaleSizeIncreaseLowQuality;                                               //@synthesize scaleSizeIncreaseLowQuality=_scaleSizeIncreaseLowQuality - In the implementation block
...
@property (assign,nonatomic) double flatShadowScale;                                                           //@synthesize flatShadowScale=_flatShadowScale - In the implementation block
...
-(void)setMaximumOverlayDepth:(double)arg1 ;
...
-(void)setScaleSizeIncreaseLowQuality:(double)arg1 ;
...
-(void)setFlatShadowScale:(double)arg1 ;
...
-(double)maximumOverlayDepth;
-(double)zDepth;
-(BOOL)adjustMotionForSize;
-(double)rotationAmount;
-(double)scaleSizeIncrease;
-(double)scaleSizeIncreaseLowQuality;
