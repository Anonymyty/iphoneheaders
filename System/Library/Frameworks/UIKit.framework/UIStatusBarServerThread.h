...
@interface UIStatusBarServerThread : NSThread {
	...
	SCD_Struct_UI77 _statusBarData;
	SCD_Struct_UI77 _composedStatusBarData;
	SCD_Struct_UI78 _overrides;
...
-(SCD_Struct_UI78*)_statusBarOverrideData;
-(void)_postStatusBarData:(SCD_Struct_UI77*)arg1 actions:(int)arg2 ;
...
-(void)_postStatusBarOverrideData:(SCD_Struct_UI78*)arg1 ;
