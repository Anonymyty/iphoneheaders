...
@class NSArray, NSString, _UIPreviewActionSheetItemView, UIScrollView, UIPanGestureRecognizer, UILongPressGestureRecognizer, _UIDimmingKnockoutBackdropView;
...
@property (assign,nonatomic,__weak) _UIDimmingKnockoutBackdropView * backdropView;                   //@synthesize backdropView=_backdropView - In the implementation block
