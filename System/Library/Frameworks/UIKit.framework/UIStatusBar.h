...
@interface UIStatusBar : _UIScrollsToTopInitiatorView <UIStatusBarServerClient, UIStatusBarStateObserver> {
	...
	SCD_Struct_UI77 _currentRawData;
	...
	SCD_Struct_UI78* _localDataOverrides;
	UIColor* _tintColor;
...
+(void)getData:(SCD_Struct_UI77*)arg1 forRequestedData:(const SCD_Struct_UI77*)arg2 withOverrides:(const SCD_Struct_UI78*)arg3 ;
...
-(void)statusBarServer:(id)arg1 didReceiveStatusBarData:(const SCD_Struct_UI77*)arg2 withActions:(int)arg3 ;
...
-(void)forceUpdateToData:(const SCD_Struct_UI77*)arg1 animated:(BOOL)arg2 ;
...
-(void)statusBarStateProvider:(id)arg1 didPostStatusBarData:(const SCD_Struct_UI77*)arg2 withActions:(int)arg3 ;
...
-(void)setLocalDataOverrides:(SCD_Struct_UI78*)arg1 ;
-(CGRect)currentFrame;
-(long long)_requestedStyle;
