...
@class UIGestureRecognizer, UIInteractionProgress, UIView, UIScrollView, _UIPreviewActionSheetView, UIPreviewForceInteractionProgress, _UIPreviewPresentationContainerView, UIVisualEffectView, _UIPreviewPresentationEffectView, NSArray, UIPreviewAction, _UIPreviewQuickActionView, NSLayoutConstraint, UIImageView, UITapGestureRecognizer, _UIPlatterMenuDynamicsController, _UIPlatterPanningVelocityIntegrator, _UIPreviewPresentationAnimator, NSString;
