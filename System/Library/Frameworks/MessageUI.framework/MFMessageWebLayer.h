...
@class NSString, NSTimer, NSObject, MFLibraryMessage, NSMutableDictionary, DOMNodeList, MFMessageReformattingContext, DOMRange;
...
-(void)updateImageWithCID:(id)arg1 withNewCID:(id)arg2 newImageSize:(CGSize)arg3 ;
