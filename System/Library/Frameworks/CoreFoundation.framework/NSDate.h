...
@interface NSDate : NSObject <CKDParsedObject, CKRecordValue, NSCopying, NSSecureCoding>
...
-(id)dateWithFloorForAlignment:(double)arg1 withOffset:(double)arg2 inTimeZone:(id)arg3 ;
-(id)dateWithFloorForAlignment:(double)arg1 ;
-(id)dateWithCeilingForAlignment:(double)arg1 withOffset:(double)arg2 inTimeZone:(id)arg3 ;
...
-(id)_dk_endOfDay;
-(BOOL)_dk_inTimeState:(long long)arg1 ;
