...
@interface NSURL : NSObject <QLPreviewItem, CKXPCSuitableString, SBFFileCacheFileIdentifier, NSSecureCoding, NSCopying> {
...
+(id)_web_URLWithComponents:(SCD_Struct_NS29)arg1 ;
...
-(SCD_Struct_NS29)_web_URLComponents;
