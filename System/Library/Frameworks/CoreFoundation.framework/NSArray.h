...
@interface NSArray : NSObject <CKDParsedObject, CKRecordValue, CSCoderEncoder, NSCopying, NSMutableCopying, NSSecureCoding, NSFastEnumeration>
...
-(id)_maps_firstObjectPassingTest:(/*^block*/id)arg1 ;
...
-(id)naui_arrayWithResultsOfBlock:(/*^block*/id)arg1 ;
-(id)naui_arrayByFlattening;
-(void)naui_each:(/*^block*/id)arg1 ;
-(id)naui_filter:(/*^block*/id)arg1 ;
-(BOOL)naui_any:(/*^block*/id)arg1 ;
-(BOOL)naui_all:(/*^block*/id)arg1 ;
-(id)naui_firstObjectPassingTest:(/*^block*/id)arg1 ;
-(id)naui_map:(/*^block*/id)arg1 ;
