...
-(void)_mapkit_sortUsingDistanceFromCoordinate:(SCD_Struct_NS22)arg1 ascending:(BOOL)arg2 ;
-(void)_mapkit_sortUsingDistanceFromCoordinate:(SCD_Struct_NS22)arg1 ;
