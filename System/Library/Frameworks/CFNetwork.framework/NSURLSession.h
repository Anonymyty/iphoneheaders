...
-(void)delegate_AVAssetDownloadTask:(id)arg1 didLoadTimeRange:(SCD_Struct_NS25)arg2 totalTimeRangesLoaded:(id)arg3 timeRangeExpectedToLoad:(SCD_Struct_NS25)arg4 ;
