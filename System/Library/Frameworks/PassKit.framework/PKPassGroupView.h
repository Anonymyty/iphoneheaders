...
@class NSMutableDictionary, PKReusablePassViewQueue, UIScrollView, UIPageControl, UIView, UIPanGestureRecognizer, UILongPressGestureRecognizer, UIMotionEffectGroup, PKGroup, PKPassView, NSString;
...
@property (nonatomic,readonly) BOOL pageControlHidden;                                   //@synthesize pageControlHidden=_pageControlHidden - In the implementation block
