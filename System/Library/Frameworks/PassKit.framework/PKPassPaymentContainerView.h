...
@class PKPaymentService, PKAuthenticator, PKContactlessInterfaceSession, PKPassPaymentPayStateView, UIView, PKPassLibrary, PKPassPaymentSummaryView, PKPassPaymentApplicationView, PKPassValueAddedServiceInfoView, UIButton, NSString, NSMutableArray, PKWeakReference, NSNumber, NSObject, PKPaymentConfirmationAlertController, NSData;
