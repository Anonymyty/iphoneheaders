...
@property (assign,nonatomic) unsigned short versionMadeBy;                        //@synthesize versionMadeBy=_versionMadeBy - In the implementation block
...
@property (nonatomic,readonly) unsigned short fileCommentLength;                  //@synthesize fileCommentLength=_fileCommentLength - In the implementation block
@property (assign,nonatomic) unsigned short fileStartDiskNumber;                  //@synthesize fileStartDiskNumber=_fileStartDiskNumber - In the implementation block
@property (assign,nonatomic) unsigned short internalFileAttrs;                    //@synthesize internalFileAttrs=_internalFileAttrs - In the implementation block
@property (assign,nonatomic) unsigned externalFileAttrs;                          //@synthesize externalFileAttrs=_externalFileAttrs - In the implementation block
@property (assign,nonatomic) unsigned localFileHeaderRelativeOffset;              //@synthesize localFileHeaderRelativeOffset=_localFileHeaderRelativeOffset - In the implementation block
...
@property (nonatomic,retain) NSString * fileComment;                              //@synthesize fileComment=_fileComment - In the implementation block
-(unsigned long long)loadFromBytes:(const char*)arg1 offset:(unsigned long long)arg2 ;
-(unsigned)uncompressedSize;
-(unsigned)localFileHeaderRelativeOffset;
-(unsigned short)compressionMethod;
-(void)setExtraFieldData:(NSData *)arg1 ;
-(void)setFileComment:(NSString *)arg1 ;
...
-(unsigned)externalFileAttrs;
-(void)setExternalFileAttrs:(unsigned)arg1 ;
-(void)setLocalFileHeaderRelativeOffset:(unsigned)arg1 ;
