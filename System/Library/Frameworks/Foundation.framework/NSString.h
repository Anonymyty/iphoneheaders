...
@interface NSString : NSObject <ASParsingLeafNode, CKDParsedObject, CKShortDescription, CKRecordValue, CNKeyDescriptor_Private, CSCoderEncoder, SBFFileCacheFileIdentifier, NSCopying, NSMutableCopying, NSSecureCoding>
...
+(id)stringWithDirection:(double)arg1 abbreviated:(BOOL)arg2 ;
+(id)stringWithTime:(id)arg1 ;
+(id)stringWithAltitudeUnits;
+(id)_maps_replacementForFormatToken:(id)arg1 timeStampTimeZone:(id)arg2 forSpokenText:(BOOL)arg3 ;
+(id)stringWithRemainingTime:(double)arg1 allowShortForm:(BOOL)arg2 showPastTimes:(BOOL)arg3 ;
+(id)_maps_stringForServerFormattedString:(id)arg1 timeZone:(id)arg2 forSpokenText:(BOOL)arg3 overrideVariables:(id)arg4 ;
+(id)stringWithSeconds:(unsigned long long)arg1 withTraffic:(BOOL)arg2 abbreviated:(BOOL)arg3 ;
...
+(id)_mapkit_localizedDistanceStringWithMeters:(unsigned)arg1 includeTrip:(BOOL)arg2 abbreviated:(BOOL)arg3 ;
+(id)_mapkit_voiceOverLocalizedDistanceStringWithMeters:(unsigned)arg1 includeTrip:(BOOL)arg2 ;
...
-(CGSize)_maps_sizeWithFont:(id)arg1 constrainedToSize:(CGSize)arg2 ;
-(void)_maps_drawAtPoint:(CGPoint)arg1 withFont:(id)arg2 ;
-(CGSize)_maps_sizeWithFont:(id)arg1 ;
-(CGSize)_maps_sizeWithFont:(id)arg1 constrainedToSize:(CGSize)arg2 options:(long long)arg3 ;
-(void)_maps_drawInRect:(CGRect)arg1 withFont:(id)arg2 ;
-(id)_maps_prefixMatchesForSearchString:(id)arg1 ;
...
-(long long)editDistanceFromStringIgnoringSpaces:(id)arg1 ;
-(long long)editDistanceFromString:(id)arg1 ;
