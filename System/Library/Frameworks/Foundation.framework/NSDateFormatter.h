...
+(id)_maps_localizedTimestampStringForDepartureArrivalDate:(id)arg1 inTimeZone:(id)arg2 canIncludeDate:(BOOL)arg3 ;
+(id)_maps_weekdayForDate:(id)arg1 ;
+(void)_maps_localizedTimestampStrings:(inout id*)arg1 departureDate:(id)arg2 departureTimeZone:(id)arg3 arrivalString:(inout id*)arg4 arrivalDate:(id)arg5 arrivalTimeZone:(id)arg6 canIncludeDate:(BOOL)arg7 ;
+(id)_maps_localizedTimestampStringForDepartureArrivalDate:(id)arg1 inTimeZone:(id)arg2 canIncludeDate:(BOOL)arg3 relativeToTimeZone:(id)arg4 ;
...
+(id)_maps_localizedTimestampStringForDepartureArrivalDate:(id)arg1 inTimeZone:(id)arg2 canIncludeDate:(BOOL)arg3 suppressTimeZoneDisplay:(BOOL)arg4 useShortFormat:(BOOL)arg5 ;
+(id)_maps_localizedTimestampStringForDepartureArrivalDate:(id)arg1 inTimeZone:(id)arg2 canIncludeDate:(BOOL)arg3 showTimeZone:(BOOL)arg4 useShortFormat:(BOOL)arg5 ;
