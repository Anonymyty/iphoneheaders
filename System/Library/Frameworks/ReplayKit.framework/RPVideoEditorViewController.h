...
@class NSURL, NSString, AVPlayer, AVPlayerLayer, AVPlayerItem, AVURLAsset, UIView, NSObject, UIToolbar, UIBarButtonItem, UILabel, AVAssetExportSession, UIMovieScrubber, AVAssetImageGenerator, NSMutableDictionary, NSMutableArray;
