...
@class NSString, CKContainerID, CKRecordID, CKDatabase, NSXPCConnection, NSOperationQueue, CKOperationCallbackManager, CKOperationFlowControlManager, CKAccountInfo, ACAccountStore, NSMutableArray, CKContainerSetupInfo, NSMapTable;
