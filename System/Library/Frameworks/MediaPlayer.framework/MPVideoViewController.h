...
@class UIView, UIColor, _UIHostedWindow, UIImage, MPVideoView, MPVideoBackgroundView, MPSwipableView, MPClosedCaptionDisplay, UIActivityIndicatorView, MPTVOutWindow, UIAlertController, NSString, MPAVItem, MPAVController;
