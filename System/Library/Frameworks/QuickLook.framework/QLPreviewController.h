...
-(long long)defaultWhitePointAdaptivityStyleForCurrentPreviewItem;
...
-(void)previewContentControllerPrefersWhitePointAdaptiveStyle:(long long)arg1 atIndex:(unsigned long long)arg2 ;
