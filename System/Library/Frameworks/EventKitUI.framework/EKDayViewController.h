...
@protocol UIViewControllerPreviewing, EKDayViewControllerDelegate, EKDayViewControllerDataSource;
@class UIView, UIScrollView, EKDayView, EKDayViewWithGutters, NSDateComponents, CalendarOccurrencesCollection, EKEventGestureController, ScrollSpringFactory, NSCalendar, EKEventEditViewController, NSTimer, NSString;
...
-(UIView *)currentDayContentGridView;
