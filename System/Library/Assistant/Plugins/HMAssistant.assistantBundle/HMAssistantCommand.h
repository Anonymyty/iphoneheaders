...
@class HMClientConnection, HMAssistantGather, NSArray, NSString, HMHAPMetadata;

@interface HMAssistantCommand : SAHACommand <AFServiceCommand> {

	HMClientConnection* _clientConnection;
...
@property (nonatomic,retain) HMClientConnection * clientConnection;              //@synthesize clientConnection=_clientConnection - In the implementation block
...
-(id)compare:(id)arg1 withMetadata:(id)arg2 ;
...
-(HMClientConnection *)clientConnection;
-(void)setClientConnection:(HMClientConnection *)arg1 ;
@end
