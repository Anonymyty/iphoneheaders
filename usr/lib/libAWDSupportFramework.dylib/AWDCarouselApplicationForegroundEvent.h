...
@class NSString, AWDCarouselPreviousForeground, AWDCarouselPreviousExit, NSMutableArray;
...
@property (nonatomic,retain) AWDCarouselPreviousExit * previousExit;                          //@synthesize previousExit=_previousExit - In the implementation block
+(Class)prewarmsType;
-(void)dealloc;
...
-(void)setPreviousExit:(AWDCarouselPreviousExit *)arg1 ;
-(BOOL)hasPreviousExit;
-(AWDCarouselPreviousExit *)previousExit;
