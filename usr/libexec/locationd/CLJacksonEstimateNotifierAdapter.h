...
#import <locationd/CLJacksonEstimateNotifierProtocol.h>

@class NSString;

@interface CLJacksonEstimateNotifierAdapter : CLNotifierServiceAdapter <CLJacksonEstimateNotifierProtocol>
...
-(void)beginService;
-(void)endService;
-(CLJacksonEstimateNotifier*)adaptee;
