...
#import <locationd/CLCapabilityMonitorClientProtocol.h>

@class NSString;

@interface CLClientManagerAdapter : CLNotifierServiceAdapter <CLClientManagerProtocol, CLCapabilityMonitorClientProtocol>
