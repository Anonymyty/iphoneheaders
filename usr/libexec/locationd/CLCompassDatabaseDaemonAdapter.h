...
#import <locationd/CLCompassDatabaseDaemonProtocol.h>

@class NSString;

@interface CLCompassDatabaseDaemonAdapter : CLNotifierServiceAdapter <CLCompassDatabaseDaemonProtocol>
...
-(void)beginService;
-(void)endService;
-(CLCompassDatabaseDaemon*)adaptee;
