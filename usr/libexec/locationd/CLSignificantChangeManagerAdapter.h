...
#import <locationd/CLSignificantChangeManagerProtocol.h>
...
-(void)fetchLastSignificantLocationDistanceAndLatencyWithReply:(/*^block*/id)arg1 ;
-(void)doAsync:(/*^block*/id)arg1 ;
-(void)doAsync:(/*^block*/id)arg1 withReply:(/*^block*/id)arg2 ;
-(BOOL)syncgetDoSync:(/*^block*/id)arg1 ;
-(void)beginService;
-(void)endService;
-(CLSignificantChangeManager*)adaptee;
