...
#import <locationd/CLQmiPdsManagerProtocol.h>

@class NSString;

@interface CLQmiPdsManagerAdapter : CLNotifierServiceAdapter <CLEmergencyClientProtocol, CLQmiPdsManagerProtocol>
