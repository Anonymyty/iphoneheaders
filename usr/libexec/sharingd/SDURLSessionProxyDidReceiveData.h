...
@class NSData, SDURLSessionProxyTaskMessage;

@interface SDURLSessionProxyDidReceiveData : PBCodable <NSCopying> {
...
@property (nonatomic,readonly) BOOL hasReceivedData; 
@property (nonatomic,retain) NSData * receivedData;                            //@synthesize receivedData=_receivedData - In the implementation block
-(BOOL)hasTask;
