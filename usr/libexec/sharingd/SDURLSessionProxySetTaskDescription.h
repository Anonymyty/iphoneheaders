...
@class SDURLSessionProxyTaskMessage, NSString;
...
@property (nonatomic,readonly) BOOL hasTaskDescription; 
@property (nonatomic,retain) NSString * taskDescription;                       //@synthesize taskDescription=_taskDescription - In the implementation block
-(BOOL)hasTask;
