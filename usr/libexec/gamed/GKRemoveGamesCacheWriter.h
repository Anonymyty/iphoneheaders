...
-(void)bindParametersForRequestsStatement:(sqlite3_stmtRef)arg1 playerID:(id)arg2 digest:(id)arg3 ;
-(GKDatabaseConnection *)databaseConnection;
-(id)removeGamesInsertSQL;
-(void)bindParametersForRemoveGamesStatement:(sqlite3_stmtRef)arg1 forRemovedBundleID:(id)arg2 requestsRowID:(long long)arg3 ;
-(void)dealloc;
