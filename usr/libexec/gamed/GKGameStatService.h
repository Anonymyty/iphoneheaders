...
-(oneway void)getAchievementsForGameDescriptor:(id)arg1 players:(id)arg2 handler:(/*^block*/id)arg3;
...
-(oneway void)getLeaderboardsForGameDescriptor:(id)arg1 player:(id)arg2 setIdentifier:(id)arg3 handler:(/*^block*/id)arg4;
...
-(oneway void)getRecentMatchesForGameDescriptor:(id)arg1 otherPlayer:(id)arg2 handler:(/*^block*/id)arg3;
...
-(void)getRecentGamesWithPlayer:(id)arg1 handler:(/*^block*/id)arg2 ;
...
-(void)loadAchievementsForGame:(id)arg1 players:(id)arg2 context:(id)arg3 handler:(/*^block*/id)arg4 ;
-(void)fetchAchievementsForGame:(id)arg1 players:(id)arg2 context:(id)arg3 handler:(/*^block*/id)arg4 ;
-(void)cleanUpLeaderboardTitles:(id)arg1 set:(id)arg2 context:(id)arg3 ;
-(void)loadLeaderboardsForGameDescriptor:(id)arg1 player:(id)arg2 setIdentifier:(id)arg3 context:(id)arg4 handler:(/*^block*/id)arg5 ;
-(void)fetchLeaderboardsForGameDescriptor:(id)arg1 player:(id)arg2 setIdentifier:(id)arg3 context:(id)arg4 handler:(/*^block*/id)arg5 ;
-(oneway void)getPlayersForGameDescriptor:(id)arg1 includeCompatibleMultiplayerGames:(BOOL)arg2 handler:(/*^block*/id)arg3 ;
-(oneway void)getPlayersForGameDescriptor:(id)arg1 leaderboardIdentifier:(id)arg2 handler:(/*^block*/id)arg3 ;
-(oneway void)getPlayersForGameDescriptor:(id)arg1 achievementIdentifier:(id)arg2 handler:(/*^block*/id)arg3 ;
-(oneway void)getAchievementsForGameDescriptor:(id)arg1 players:(id)arg2 handler:(/*^block*/id)arg3 ;
