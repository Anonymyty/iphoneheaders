...
-(void)bindParametersForStatement:(sqlite3_stmtRef)arg1 playerID:(id)arg2 daysAgo:(unsigned long long)arg3 ;
-(id)getSubmitScoreDescriptorsStatementForDaysAgo:(unsigned long long)arg1 ;
-(id)scoreForExecutedStatement:(sqlite3_stmtRef)arg1 ;
-(id)eligibleChallengeIDsForExecutedStatement:(sqlite3_stmtRef)arg1 ;
-(void)dealloc;
