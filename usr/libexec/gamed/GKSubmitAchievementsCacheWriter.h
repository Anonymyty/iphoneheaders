...
-(unsigned)refreshDataType;
-(GKDatabaseConnection *)databaseConnection;
-(void)bindParametersForRequestsStatement:(sqlite3_stmtRef)arg1 achievevement:(id)arg2 digest:(id)arg3 ;
-(id)achievementsInsertSQL;
-(void)bindParametersForAchievementsStatement:(sqlite3_stmtRef)arg1 achievement:(id)arg2 shouldScreen:(BOOL)arg3 eligibleChallenges:(id)arg4 requestsRowID:(long long)arg5 ;
-(void)dealloc;
