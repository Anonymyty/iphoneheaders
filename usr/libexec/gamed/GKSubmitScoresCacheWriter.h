...
-(void)bindParametersForRequestsStatement:(sqlite3_stmtRef)arg1 score:(id)arg2 digest:(id)arg3 ;
-(id)scoresInsertSQL;
-(void)bindParametersForScoresStatement:(sqlite3_stmtRef)arg1 score:(id)arg2 shouldScreen:(BOOL)arg3 eligibleChallenges:(id)arg4 requestsRowID:(long long)arg5 ;
-(void)dealloc;
