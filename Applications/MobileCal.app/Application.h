...
@property (assign,nonatomic) BOOL showingSplashScreen;                                         //@synthesize showingSplashScreen=_showingSplashScreen - In the implementation block
...
-(void)setShowingSplashScreen:(BOOL)arg1 ;
