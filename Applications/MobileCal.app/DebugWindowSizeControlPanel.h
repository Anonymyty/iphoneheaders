...
@property (assign) double debugWindowSizeAnimationStepSize;                                       //@synthesize debugWindowSizeAnimationStepSize=_debugWindowSizeAnimationStepSize - In the implementation block
@property (assign) id<DebugWindowSizeButtonDelegate> delegate;                                    //@synthesize delegate=_delegate - In the implementation block
-(double)debugWindowSizeAnimationStepSize;
...
-(void)setDebugWindowSizeAnimationStepSize:(double)arg1 ;
